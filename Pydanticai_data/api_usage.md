...
Examples 
  ...
  * API Reference  API Reference 
    ...
    * pydantic_ai.usage  [ pydantic_ai.usage  ](./) Table of contents 
      * [ usage  ](#pydantic_ai.usage)
      * [ Usage  ](#pydantic_ai.usage.Usage)
        * [ requests  ](#pydantic_ai.usage.Usage.requests)
        * [ request_tokens  ](#pydantic_ai.usage.Usage.request_tokens)
        * [ response_tokens  ](#pydantic_ai.usage.Usage.response_tokens)
        * [ total_tokens  ](#pydantic_ai.usage.Usage.total_tokens)
        * [ details  ](#pydantic_ai.usage.Usage.details)
        * [ incr  ](#pydantic_ai.usage.Usage.incr)
        * [ __add__  ](#pydantic_ai.usage.Usage.__add__)
      * [ UsageLimits  ](#pydantic_ai.usage.UsageLimits)
        * [ request_limit  ](#pydantic_ai.usage.UsageLimits.request_limit)
        * [ request_tokens_limit  ](#pydantic_ai.usage.UsageLimits.request_tokens_limit)
        * [ response_tokens_limit  ](#pydantic_ai.usage.UsageLimits.response_tokens_limit)
        * [ total_tokens_limit  ](#pydantic_ai.usage.UsageLimits.total_tokens_limit)
        * [ has_token_limits  ](#pydantic_ai.usage.UsageLimits.has_token_limits)
        * [ check_before_request  ](#pydantic_ai.usage.UsageLimits.check_before_request)
        * [ check_tokens  ](#pydantic_ai.usage.UsageLimits.check_tokens)
