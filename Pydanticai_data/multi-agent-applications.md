...
joke_selection_agent = Agent( [](#__code_0_annotation_1)
  'openai:gpt-4o',
  system_prompt=(
...
joke_generation_agent = Agent( [](#__code_0_annotation_2)
  'google-gla:gemini-1.5-flash', result_type=list[str]
)

@joke_selection_agent.tool
async def joke_factory(ctx: RunContext[None], count: int) -> list[str]:
  r = await joke_generation_agent.run( [](#__code_0_annotation_3)
    f'Please generate {count} jokes.',
    usage=ctx.usage, [](#__code_0_annotation_4)
  )
  return r.data [](#__code_0_annotation_5)
...
@dataclass
class ClientAndKey: [](#__code_1_annotation_1)
  http_client: httpx.AsyncClient
  api_key: str

joke_selection_agent = Agent(
  'openai:gpt-4o',
  deps_type=ClientAndKey, [](#__code_1_annotation_2)
  system_prompt=(
...
joke_generation_agent = Agent(
  'gemini-1.5-flash',
  deps_type=ClientAndKey, [](#__code_1_annotation_4)
...
async def joke_factory(ctx: RunContext[ClientAndKey], count: int) -> list[str]:
  r = await joke_generation_agent.run(
    f'Please generate {count} jokes.',
    deps=ctx.deps, [](#__code_1_annotation_3)
    usage=ctx.usage,
  )
  return r.data

@joke_generation_agent.tool [](#__code_1_annotation_5)
...
async def main():
  async with httpx.AsyncClient() as client:
    ...
    print(result.data)
    #> Did you hear about the toothpaste scandal? They called it Colgate.
    print(result.usage()) [](#__code_1_annotation_6)
"""
    Usage(
      requests=4,
      request_tokens=309,
...
flight_search_agent = Agent[None, Union[FlightDetails, Failed]]( [](#__code_2_annotation_1)
  'openai:gpt-4o',
...
@flight_search_agent.tool [](#__code_2_annotation_2)
...
usage_limits = UsageLimits(request_limit=15) [](#__code_2_annotation_3)

async def find_flight(usage: Usage) -> Union[FlightDetails, None]: [](#__code_2_annotation_4)
...
seat_preference_agent = Agent[None, Union[SeatPreference, Failed]]( [](#__code_2_annotation_5)
  'openai:gpt-4o',
...
async def find_seat(usage: Usage) -> SeatPreference: [](#__code_2_annotation_6)
  message_history: Union[list[ModelMessage], None] = None
  while True:
...
async def main(): [](#__code_2_annotation_7)
  usage: Usage = Usage()
