---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/checkpoint.CheckpointMetadata.html
title: Untitled
date_crawled: 
---
...
interface CheckpointMetadata { [parents](checkpoint.CheckpointMetadata.html#parents): Record<string, string>; [source](checkpoint.CheckpointMetadata.html#source): "input" | "loop" | "update" | "fork"; [step](checkpoint.CheckpointMetadata.html#step): number; [writes](checkpoint.CheckpointMetadata.html#writes): null | Record<string, unknown>; }

  * Defined in libs/checkpoint/dist/types.d.ts:8
...
[parents](checkpoint.CheckpointMetadata.html#parents) [source](checkpoint.CheckpointMetadata.html#source) [step](checkpoint.CheckpointMetadata.html#step) [writes](checkpoint.CheckpointMetadata.html#writes)
...
The IDs of the parent checkpoints. Mapping from checkpoint namespace to checkpoint ID.
  ...
  * Defined in libs/checkpoint/dist/types.d.ts:33
...
The source of the checkpoint.
  ...
  * Defined in libs/checkpoint/dist/types.d.ts:16
...
The step number of the checkpoint. -1 for the first "input" checkpoint. 0 for the first "loop" checkpoint. ... for the nth checkpoint afterwards.
  ...
  * Defined in libs/checkpoint/dist/types.d.ts:23
...
The writes that were made between the previous checkpoint and this one. Mapping from node name to writes emitted by that node.
  ...
  * Defined in libs/checkpoint/dist/types.d.ts:28
...
[parents](#parents)[source](#source)[step](#step)[writes](#writes)
