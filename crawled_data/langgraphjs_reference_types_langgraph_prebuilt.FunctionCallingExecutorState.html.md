---
url: https://langchain-ai.github.io/langgraphjs/reference/types/langgraph_prebuilt.FunctionCallingExecutorState.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [FunctionCallingExecutorState](langgraph_prebuilt.FunctionCallingExecutorState.html)



# Type alias FunctionCallingExecutorState

FunctionCallingExecutorState: { messages: BaseMessage[]; }
...
Use [createReactAgent](../functions/langgraph_prebuilt.createReactAgent.html) instead with tool calling.

  * Defined in libs/langgraph/dist/prebuilt/chat_agent_executor.d.ts:8
