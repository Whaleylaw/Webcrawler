---
url: https://langchain-ai.github.io/langgraphjs/reference/functions/langgraph_prebuilt.createFunctionCallingExecutor.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [createFunctionCallingExecutor](langgraph_prebuilt.createFunctionCallingExecutor.html)



# Function createFunctionCallingExecutor

  * createFunctionCallingExecutor<[Model](langgraph_prebuilt.createFunctionCallingExecutor.html#createFunctionCallingExecutor.Model)>(__namedParameters): [CompiledStateGraph](../classes/langgraph.CompiledStateGraph.html)<[FunctionCallingExecutorState](../types/langgraph_prebuilt.FunctionCallingExecutorState.html), Partial<[FunctionCallingExecutorState](../types/langgraph_prebuilt.FunctionCallingExecutorState.html)>, typeof [START](../variables/langgraph.START.html) | "agent" | "action">[](#createFunctionCallingExecutor)
  * #### Type Parameters
...
#### Parameters
    ...
    * __namedParameters: { model: [Model](langgraph_prebuilt.createFunctionCallingExecutor.html#createFunctionCallingExecutor.Model); tools: (RunnableToolLike<ZodType<any, ZodTypeDef, any>, unknown> | StructuredToolInterface<ZodObjectAny>)[] | [ToolExecutor](../classes/langgraph_prebuilt.ToolExecutor.html); }
      * ##### model: [Model](langgraph_prebuilt.createFunctionCallingExecutor.html#createFunctionCallingExecutor.Model)

      * ##### tools: (RunnableToolLike<ZodType<any, ZodTypeDef, any>, unknown> | StructuredToolInterface<ZodObjectAny>)[] | [ToolExecutor](../classes/langgraph_prebuilt.ToolExecutor.html)

#### Returns [CompiledStateGraph](../classes/langgraph.CompiledStateGraph.html)<[FunctionCallingExecutorState](../types/langgraph_prebuilt.FunctionCallingExecutorState.html), Partial<[FunctionCallingExecutorState](../types/langgraph_prebuilt.FunctionCallingExecutorState.html)>, typeof [START](../variables/langgraph.START.html) | "agent" | "action">

#### Deprecated

Use [createReactAgent](langgraph_prebuilt.createReactAgent.html) instead with tool calling.
