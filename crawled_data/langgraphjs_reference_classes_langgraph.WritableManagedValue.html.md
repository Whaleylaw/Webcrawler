---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.WritableManagedValue.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [WritableManagedValue](langgraph.WritableManagedValue.html)



# Class WritableManagedValue<Value, Update>`Abstract`
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.WritableManagedValue))

  * [ManagedValue](langgraph.ManagedValue.html)<[Value](langgraph.WritableManagedValue.html#constructor.new_WritableManagedValue.Value-1)>
    * WritableManagedValue
      * [SharedValue](langgraph.SharedValue.html)



  * Defined in libs/langgraph/dist/managed/base.d.ts:15
...
[constructor](langgraph.WritableManagedValue.html#constructor)

### Properties

[config](langgraph.WritableManagedValue.html#config) [lg_is_managed_value](langgraph.WritableManagedValue.html#lg_is_managed_value) [runtime](langgraph.WritableManagedValue.html#runtime)

### Methods

[addPromise](langgraph.WritableManagedValue.html#addPromise) [call](langgraph.WritableManagedValue.html#call) [promises](langgraph.WritableManagedValue.html#promises) [update](langgraph.WritableManagedValue.html#update-2) [initialize](langgraph.WritableManagedValue.html#initialize)

## Constructors

### constructor[](#constructor)

  * new WritableManagedValue<[Value](langgraph.WritableManagedValue.html#constructor.new_WritableManagedValue.Value-1), [Update](langgraph.WritableManagedValue.html#constructor.new_WritableManagedValue.Update-1)>(config, _params?): [WritableManagedValue](langgraph.WritableManagedValue.html)<[Value](langgraph.WritableManagedValue.html#constructor.new_WritableManagedValue.Value-1), [Update](langgraph.WritableManagedValue.html#constructor.new_WritableManagedValue.Update-1)>[](#constructor.new_WritableManagedValue)
  * #### Type Parameters
...
#### Parameters
    ...
    * `Optional` _params: [ManagedValueParams](../interfaces/langgraph.ManagedValueParams.html)

#### Returns [WritableManagedValue](langgraph.WritableManagedValue.html)<[Value](langgraph.WritableManagedValue.html#constructor.new_WritableManagedValue.Value-1), [Update](langgraph.WritableManagedValue.html#constructor.new_WritableManagedValue.Update-1)>

Inherited from [ManagedValue](langgraph.ManagedValue.html).[constructor](langgraph.ManagedValue.html#constructor)

    * Defined in libs/langgraph/dist/managed/base.d.ts:9
...
Inherited from [ManagedValue](langgraph.ManagedValue.html).[config](langgraph.ManagedValue.html#config)
...
Inherited from [ManagedValue](langgraph.ManagedValue.html).[lg_is_managed_value](langgraph.ManagedValue.html#lg_is_managed_value)
...
Inherited from [ManagedValue](langgraph.ManagedValue.html).[runtime](langgraph.ManagedValue.html#runtime)
...
Inherited from [ManagedValue](langgraph.ManagedValue.html).[addPromise](langgraph.ManagedValue.html#addPromise)
...
### `Abstract` call[](#call)
  ...
  * call(step): [Value](langgraph.WritableManagedValue.html#constructor.new_WritableManagedValue.Value-1)[](#call.call-1)
  * #### Parameters

    * step: number

#### Returns [Value](langgraph.WritableManagedValue.html#constructor.new_WritableManagedValue.Value-1)

Inherited from [ManagedValue](langgraph.ManagedValue.html).[call](langgraph.ManagedValue.html#call)

    * Defined in libs/langgraph/dist/managed/base.d.ts:11
...
Inherited from [ManagedValue](langgraph.ManagedValue.html).[promises](langgraph.ManagedValue.html#promises)

    * Defined in libs/langgraph/dist/managed/base.d.ts:12



### `Abstract` update[](#update-2)

  * update(writes): Promise<void>[](#update-2.update-3)
  * #### Parameters

    * writes: [Update](langgraph.WritableManagedValue.html#constructor.new_WritableManagedValue.Update-1)[]

#### Returns Promise<void>

    * Defined in libs/langgraph/dist/managed/base.d.ts:16



### `Static` initialize[](#initialize)

  * initialize<[Value](langgraph.WritableManagedValue.html#initialize.initialize-1.Value-2)>(_config, _args?): Promise<[ManagedValue](langgraph.ManagedValue.html)<[Value](langgraph.ManagedValue.html#initialize.initialize-1.Value-2)>>[](#initialize.initialize-1)
  * #### Type Parameters
...
#### Returns Promise<[ManagedValue](langgraph.ManagedValue.html)<[Value](langgraph.ManagedValue.html#initialize.initialize-1.Value-2)>>

Inherited from [ManagedValue](langgraph.ManagedValue.html).[initialize](langgraph.ManagedValue.html#initialize)

    * Defined in libs/langgraph/dist/managed/base.d.ts:10
...
[constructor](#constructor)[config](#config)[lg_is_managed_value](#lg_is_managed_value)[runtime](#runtime)[addPromise](#addPromise)[call](#call)[promises](#promises)[update](#update-2)[initialize](#initialize)
