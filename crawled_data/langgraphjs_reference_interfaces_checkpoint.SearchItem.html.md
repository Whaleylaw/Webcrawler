---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/checkpoint.SearchItem.html
title: Untitled
date_crawled: 
---
...
interface SearchItem { [createdAt](checkpoint.SearchItem.html#createdAt): Date; [key](checkpoint.SearchItem.html#key): string; [namespace](checkpoint.SearchItem.html#namespace): string[]; [score](checkpoint.SearchItem.html#score)?: number; [updatedAt](checkpoint.SearchItem.html#updatedAt): Date; [value](checkpoint.SearchItem.html#value): Record<string, any>; }
