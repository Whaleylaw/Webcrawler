...
[](#)
  ...
  * [MongoDBSaver](checkpoint_mongodb.MongoDBSaver.html)
...
#### Hierarchy ([view full](../hierarchy.html#checkpoint-mongodb.MongoDBSaver))
  ...
  * Defined in libs/checkpoint-mongodb/dist/index.d.ts:13
...
[constructor](checkpoint_mongodb.MongoDBSaver.html#constructor)

### Properties

[checkpointCollectionName](checkpoint_mongodb.MongoDBSaver.html#checkpointCollectionName) [checkpointWritesCollectionName](checkpoint_mongodb.MongoDBSaver.html#checkpointWritesCollectionName) [client](checkpoint_mongodb.MongoDBSaver.html#client) [db](checkpoint_mongodb.MongoDBSaver.html#db) [serde](checkpoint_mongodb.MongoDBSaver.html#serde)

### Methods

[get](checkpoint_mongodb.MongoDBSaver.html#get) [getNextVersion](checkpoint_mongodb.MongoDBSaver.html#getNextVersion) [getTuple](checkpoint_mongodb.MongoDBSaver.html#getTuple) [list](checkpoint_mongodb.MongoDBSaver.html#list) [put](checkpoint_mongodb.MongoDBSaver.html#put) [putWrites](checkpoint_mongodb.MongoDBSaver.html#putWrites)

## Constructors

### constructor[](#constructor)

  * new MongoDBSaver(__namedParameters, serde?): [MongoDBSaver](checkpoint_mongodb.MongoDBSaver.html)[](#constructor.new_MongoDBSaver)
  * #### Parameters

    * __namedParameters: [MongoDBSaverParams](../types/checkpoint_mongodb.MongoDBSaverParams.html)
    * `Optional` serde: [SerializerProtocol](../interfaces/checkpoint.SerializerProtocol.html)

#### Returns [MongoDBSaver](checkpoint_mongodb.MongoDBSaver.html)
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[constructor](checkpoint.BaseCheckpointSaver.html#constructor)
    ...
    * Defined in libs/checkpoint-mongodb/dist/index.d.ts:18
...
checkpointCollectionName: string
  ...
  * Defined in libs/checkpoint-mongodb/dist/index.d.ts:16
...
checkpointWritesCollectionName: string
  ...
  * Defined in libs/checkpoint-mongodb/dist/index.d.ts:17
...
client: MongoClient
  ...
  * Defined in libs/checkpoint-mongodb/dist/index.d.ts:14
...
db: Db
  ...
  * Defined in libs/checkpoint-mongodb/dist/index.d.ts:15
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[getTuple](checkpoint.BaseCheckpointSaver.html#getTuple)
    ...
    * Defined in libs/checkpoint-mongodb/dist/index.d.ts:25
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[list](checkpoint.BaseCheckpointSaver.html#list)
    ...
    * Defined in libs/checkpoint-mongodb/dist/index.d.ts:31



### put[](#put)

  * put(config, checkpoint, metadata): Promise<RunnableConfig<Record<string, any>>>[](#put.put-1)
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[put](checkpoint.BaseCheckpointSaver.html#put)
    ...
    * Defined in libs/checkpoint-mongodb/dist/index.d.ts:36
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[putWrites](checkpoint.BaseCheckpointSaver.html#putWrites)
    ...
    * Defined in libs/checkpoint-mongodb/dist/index.d.ts:40
...
[constructor](#constructor)[checkpointCollectionName](#checkpointCollectionName)[checkpointWritesCollectionName](#checkpointWritesCollectionName)[client](#client)[db](#db)[serde](#serde)[get](#get)[getNextVersion](#getNextVersion)[getTuple](#getTuple)[list](#list)[put](#put)[putWrites](#putWrites)
