---
url: https://langchain-ai.github.io/langgraphjs/reference/functions/langgraph.getWriter.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [getWriter](langgraph.getWriter.html)



# Function getWriter

  * getWriter(): ((chunk) => void) | undefined[](#getWriter)
  * A helper utility function that returns the [LangGraphRunnableConfig#writer](../interfaces/langgraph.LangGraphRunnableConfig.html#writer) if "custom" stream mode is enabled, otherwise undefined

#### Returns ((chunk) => void) | undefined

a reference to the [LangGraphRunnableConfig#writer](../interfaces/langgraph.LangGraphRunnableConfig.html#writer) if "custom" stream mode is enabled, otherwise undefined

    * Defined in libs/langgraph/dist/pregel/utils/config.d.ts:16
