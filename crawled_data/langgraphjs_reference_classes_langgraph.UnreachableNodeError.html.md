---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.UnreachableNodeError.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [UnreachableNodeError](langgraph.UnreachableNodeError.html)



# Class UnreachableNodeError

#### Hierarchy ([view full](../hierarchy.html#langgraph.UnreachableNodeError))
  ...
  * Defined in libs/langgraph/dist/errors.d.ts:54
...
[constructor](langgraph.UnreachableNodeError.html#constructor)

### Properties

[lc_error_code?](langgraph.UnreachableNodeError.html#lc_error_code) [message](langgraph.UnreachableNodeError.html#message) [name](langgraph.UnreachableNodeError.html#name) [stack?](langgraph.UnreachableNodeError.html#stack) [prepareStackTrace?](langgraph.UnreachableNodeError.html#prepareStackTrace) [stackTraceLimit](langgraph.UnreachableNodeError.html#stackTraceLimit)

### Accessors

[unminifiable_name](langgraph.UnreachableNodeError.html#unminifiable_name)

### Methods

[captureStackTrace](langgraph.UnreachableNodeError.html#captureStackTrace)

## Constructors

### constructor[](#constructor)

  * new UnreachableNodeError(message?, fields?): [UnreachableNodeError](langgraph.UnreachableNodeError.html)[](#constructor.new_UnreachableNodeError)
  * #### Parameters

    * `Optional` message: string
    * `Optional` fields: [BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html)

#### Returns [UnreachableNodeError](langgraph.UnreachableNodeError.html)

Overrides [BaseLangGraphError](langgraph.BaseLangGraphError.html).[constructor](langgraph.BaseLangGraphError.html#constructor)

    * Defined in libs/langgraph/dist/errors.d.ts:55
...
### `Static` unminifiable_name[](#unminifiable_name)
  ...
  * #### Returns string
    ...
    * Defined in libs/langgraph/dist/errors.d.ts:56
