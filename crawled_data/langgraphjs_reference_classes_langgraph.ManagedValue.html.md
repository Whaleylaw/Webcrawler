---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.ManagedValue.html
title: Untitled
date_crawled: 
---
...
# Class ManagedValue<Value>`Abstract`
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.ManagedValue))
  ...
  * Defined in libs/langgraph/dist/managed/base.d.ts:4
...
[constructor](langgraph.ManagedValue.html#constructor)

### Properties

[_promises](langgraph.ManagedValue.html#_promises) [config](langgraph.ManagedValue.html#config) [lg_is_managed_value](langgraph.ManagedValue.html#lg_is_managed_value) [runtime](langgraph.ManagedValue.html#runtime)

### Methods

[addPromise](langgraph.ManagedValue.html#addPromise) [call](langgraph.ManagedValue.html#call) [promises](langgraph.ManagedValue.html#promises) [initialize](langgraph.ManagedValue.html#initialize)

## Constructors

### constructor[](#constructor)

  * new ManagedValue<[Value](langgraph.ManagedValue.html#constructor.new_ManagedValue.Value-1)>(config, _params?): [ManagedValue](langgraph.ManagedValue.html)<[Value](langgraph.ManagedValue.html#constructor.new_ManagedValue.Value-1)>[](#constructor.new_ManagedValue)
  * #### Type Parameters
...
#### Returns [ManagedValue](langgraph.ManagedValue.html)<[Value](langgraph.ManagedValue.html#constructor.new_ManagedValue.Value-1)>
...
### `Private` _promises[](#_promises)

_promises: any

  * Defined in libs/langgraph/dist/managed/base.d.ts:7
...
### `Abstract` call[](#call)
  ...
  * call(step): [Value](langgraph.ManagedValue.html#constructor.new_ManagedValue.Value-1)[](#call.call-1)
  * #### Parameters

    * step: number

#### Returns [Value](langgraph.ManagedValue.html#constructor.new_ManagedValue.Value-1)
...
### `Static` initialize[](#initialize)
  ...
  * initialize<[Value](langgraph.ManagedValue.html#initialize.initialize-1.Value-2)>(_config, _args?): Promise<[ManagedValue](langgraph.ManagedValue.html)<[Value](langgraph.ManagedValue.html#initialize.initialize-1.Value-2)>>[](#initialize.initialize-1)
  * #### Type Parameters
...
[constructor](#constructor)[_promises](#_promises)[config](#config)[lg_is_managed_value](#lg_is_managed_value)[runtime](#runtime)[addPromise](#addPromise)[call](#call)[promises](#promises)[initialize](#initialize)
