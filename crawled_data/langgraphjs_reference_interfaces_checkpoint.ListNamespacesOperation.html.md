---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/checkpoint.ListNamespacesOperation.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [ListNamespacesOperation](checkpoint.ListNamespacesOperation.html)
...
interface ListNamespacesOperation { [limit](checkpoint.ListNamespacesOperation.html#limit): number; [matchConditions](checkpoint.ListNamespacesOperation.html#matchConditions)?: [MatchCondition](checkpoint.MatchCondition.html)[]; [maxDepth](checkpoint.ListNamespacesOperation.html#maxDepth)?: number; [offset](checkpoint.ListNamespacesOperation.html#offset): number; }

  * Defined in libs/checkpoint/dist/store/base.d.ts:202
...
[limit](checkpoint.ListNamespacesOperation.html#limit) [matchConditions?](checkpoint.ListNamespacesOperation.html#matchConditions) [maxDepth?](checkpoint.ListNamespacesOperation.html#maxDepth) [offset](checkpoint.ListNamespacesOperation.html#offset)
...
limit: number
  ...
  * Defined in libs/checkpoint/dist/store/base.d.ts:205



### `Optional` matchConditions[](#matchConditions)

matchConditions?: [MatchCondition](checkpoint.MatchCondition.html)[]

  * Defined in libs/checkpoint/dist/store/base.d.ts:203



### `Optional` maxDepth[](#maxDepth)

maxDepth?: number

  * Defined in libs/checkpoint/dist/store/base.d.ts:204
...
offset: number
  ...
  * Defined in libs/checkpoint/dist/store/base.d.ts:206
...
[limit](#limit)[matchConditions](#matchConditions)[maxDepth](#maxDepth)[offset](#offset)
