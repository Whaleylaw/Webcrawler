---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/checkpoint_sqlite.SqliteSaver.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [SqliteSaver](checkpoint_sqlite.SqliteSaver.html)



# Class SqliteSaver

#### Hierarchy ([view full](../hierarchy.html#checkpoint-sqlite.SqliteSaver))
  ...
  * Defined in libs/checkpoint-sqlite/dist/index.d.ts:4
...
[constructor](checkpoint_sqlite.SqliteSaver.html#constructor)

### Properties

[db](checkpoint_sqlite.SqliteSaver.html#db) [isSetup](checkpoint_sqlite.SqliteSaver.html#isSetup) [serde](checkpoint_sqlite.SqliteSaver.html#serde)

### Methods

[get](checkpoint_sqlite.SqliteSaver.html#get) [getNextVersion](checkpoint_sqlite.SqliteSaver.html#getNextVersion) [getTuple](checkpoint_sqlite.SqliteSaver.html#getTuple) [list](checkpoint_sqlite.SqliteSaver.html#list) [put](checkpoint_sqlite.SqliteSaver.html#put) [putWrites](checkpoint_sqlite.SqliteSaver.html#putWrites) [setup](checkpoint_sqlite.SqliteSaver.html#setup) [fromConnString](checkpoint_sqlite.SqliteSaver.html#fromConnString)

## Constructors

### constructor[](#constructor)

  * new SqliteSaver(db, serde?): [SqliteSaver](checkpoint_sqlite.SqliteSaver.html)[](#constructor.new_SqliteSaver)
  * #### Parameters

    * db: Database
    * `Optional` serde: [SerializerProtocol](../interfaces/checkpoint.SerializerProtocol.html)

#### Returns [SqliteSaver](checkpoint_sqlite.SqliteSaver.html)
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[constructor](checkpoint.BaseCheckpointSaver.html#constructor)
    ...
    * Defined in libs/checkpoint-sqlite/dist/index.d.ts:7
...
db: Database
  ...
  * Defined in libs/checkpoint-sqlite/dist/index.d.ts:5
...
isSetup: boolean
  ...
  * Defined in libs/checkpoint-sqlite/dist/index.d.ts:6
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[getTuple](checkpoint.BaseCheckpointSaver.html#getTuple)
    ...
    * Defined in libs/checkpoint-sqlite/dist/index.d.ts:10
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[list](checkpoint.BaseCheckpointSaver.html#list)
    ...
    * Defined in libs/checkpoint-sqlite/dist/index.d.ts:11
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[put](checkpoint.BaseCheckpointSaver.html#put)
    ...
    * Defined in libs/checkpoint-sqlite/dist/index.d.ts:12
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[putWrites](checkpoint.BaseCheckpointSaver.html#putWrites)
    ...
    * Defined in libs/checkpoint-sqlite/dist/index.d.ts:13



### `Protected` setup[](#setup)

  * setup(): void[](#setup.setup-1)
  * #### Returns void

    * Defined in libs/checkpoint-sqlite/dist/index.d.ts:9



### `Static` fromConnString[](#fromConnString)

  * fromConnString(connStringOrLocalPath): [SqliteSaver](checkpoint_sqlite.SqliteSaver.html)[](#fromConnString.fromConnString-1)
  * #### Parameters
...
#### Returns [SqliteSaver](checkpoint_sqlite.SqliteSaver.html)
    ...
    * Defined in libs/checkpoint-sqlite/dist/index.d.ts:8
...
[constructor](#constructor)[db](#db)[isSetup](#isSetup)[serde](#serde)[get](#get)[getNextVersion](#getNextVersion)[getTuple](#getTuple)[list](#list)[put](#put)[putWrites](#putWrites)[setup](#setup)[fromConnString](#fromConnString)
