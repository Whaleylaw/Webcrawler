---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/checkpoint.MemorySaver.html
title: Untitled
date_crawled: 
---
...
#### Hierarchy ([view full](../hierarchy.html#checkpoint.MemorySaver))
  ...
  * Defined in libs/checkpoint/dist/memory.d.ts:6
...
[constructor](checkpoint.MemorySaver.html#constructor)

### Properties

[serde](checkpoint.MemorySaver.html#serde) [storage](checkpoint.MemorySaver.html#storage) [writes](checkpoint.MemorySaver.html#writes)

### Methods

[_getPendingSends](checkpoint.MemorySaver.html#_getPendingSends) [get](checkpoint.MemorySaver.html#get) [getNextVersion](checkpoint.MemorySaver.html#getNextVersion) [getTuple](checkpoint.MemorySaver.html#getTuple) [list](checkpoint.MemorySaver.html#list) [put](checkpoint.MemorySaver.html#put) [putWrites](checkpoint.MemorySaver.html#putWrites)

## Constructors

### constructor[](#constructor)

  * new MemorySaver(serde?): [MemorySaver](checkpoint.MemorySaver.html)[](#constructor.new_MemorySaver)
  * #### Parameters

    * `Optional` serde: [SerializerProtocol](../interfaces/checkpoint.SerializerProtocol.html)

#### Returns [MemorySaver](checkpoint.MemorySaver.html)
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[constructor](checkpoint.BaseCheckpointSaver.html#constructor)
    ...
    * Defined in libs/checkpoint/dist/memory.d.ts:9
...
storage: Record<string, Record<string, Record<string, [Uint8Array, Uint8Array, undefined | string]>>>

  * Defined in libs/checkpoint/dist/memory.d.ts:7
...
writes: Record<string, Record<string, [string, string, Uint8Array]>>
  ...
  * Defined in libs/checkpoint/dist/memory.d.ts:8



## Methods

### _getPendingSends[](#_getPendingSends)

  * _getPendingSends(threadId, checkpointNs, parentCheckpointId?): Promise<[SendProtocol](../interfaces/checkpoint.SendProtocol.html)[]>[](#_getPendingSends._getPendingSends-1)
  * #### Parameters
...
#### Returns Promise<[SendProtocol](../interfaces/checkpoint.SendProtocol.html)[]>

    * Defined in libs/checkpoint/dist/memory.d.ts:10
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[getTuple](checkpoint.BaseCheckpointSaver.html#getTuple)
    ...
    * Defined in libs/checkpoint/dist/memory.d.ts:11
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[list](checkpoint.BaseCheckpointSaver.html#list)
    ...
    * Defined in libs/checkpoint/dist/memory.d.ts:12
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[put](checkpoint.BaseCheckpointSaver.html#put)
    ...
    * Defined in libs/checkpoint/dist/memory.d.ts:13
...
Overrides [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html).[putWrites](checkpoint.BaseCheckpointSaver.html#putWrites)
    ...
    * Defined in libs/checkpoint/dist/memory.d.ts:14
...
[constructor](#constructor)[serde](#serde)[storage](#storage)[writes](#writes)[_getPendingSends](#_getPendingSends)[get](#get)[getNextVersion](#getNextVersion)[getTuple](#getTuple)[list](#list)[put](#put)[putWrites](#putWrites)
