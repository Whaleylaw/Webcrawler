---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.LastValue.html
title: Untitled
date_crawled: 
---
...
# Class LastValue<Value>`Internal`

Stores the last value received, can receive at most one value per step.

Since `update` is only called once per step and value can only be of length 1, LastValue always stores the last value of a single node. If multiple nodes attempt to write to this channel in a single step, an error will be thrown.
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.LastValue))

  * [BaseChannel](langgraph.BaseChannel.html)<[Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1), [Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1), [Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)>
    * LastValue



  * Defined in libs/langgraph/dist/channels/last_value.d.ts:10
...
[constructor](langgraph.LastValue.html#constructor)

### Properties

[UpdateType](langgraph.LastValue.html#UpdateType) [ValueType](langgraph.LastValue.html#ValueType) [lc_graph_name](langgraph.LastValue.html#lc_graph_name) [value](langgraph.LastValue.html#value-2)

### Methods

[checkpoint](langgraph.LastValue.html#checkpoint) [consume](langgraph.LastValue.html#consume) [fromCheckpoint](langgraph.LastValue.html#fromCheckpoint) [get](langgraph.LastValue.html#get) [update](langgraph.LastValue.html#update)

## Constructors

### constructor[](#constructor)

  * new LastValue<[Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)>(): [LastValue](langgraph.LastValue.html)<[Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)>[](#constructor.new_LastValue)
  * #### Type Parameters

    * Value

#### Returns [LastValue](langgraph.LastValue.html)<[Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)>

Inherited from [BaseChannel](langgraph.BaseChannel.html).[constructor](langgraph.BaseChannel.html#constructor)
...
UpdateType: [Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)
...
ValueType: [Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[lc_graph_name](langgraph.BaseChannel.html#lc_graph_name)
  ...
  * Defined in libs/langgraph/dist/channels/last_value.d.ts:11



### value[](#value-2)

value: [] | [[Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)]

  * Defined in libs/langgraph/dist/channels/last_value.d.ts:12
...
### checkpoint[](#checkpoint)
  ...
  * checkpoint(): [Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)[](#checkpoint.checkpoint-1)
  * Return a string representation of the channel's current state.

#### Returns [Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[checkpoint](langgraph.BaseChannel.html#checkpoint)
    ...
    * Defined in libs/langgraph/dist/channels/last_value.d.ts:16
...
#### Parameters
    ...
    * `Optional` checkpoint: [Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)

#### Returns this

Overrides [BaseChannel](langgraph.BaseChannel.html).[fromCheckpoint](langgraph.BaseChannel.html#fromCheckpoint)

    * Defined in libs/langgraph/dist/channels/last_value.d.ts:13



### get[](#get)

  * get(): [Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)[](#get.get-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[get](langgraph.BaseChannel.html#get)
    ...
    * Defined in libs/langgraph/dist/channels/last_value.d.ts:15
...
#### Parameters
    ...
    * values: [Value](langgraph.LastValue.html#constructor.new_LastValue.Value-1)[]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[update](langgraph.BaseChannel.html#update)
    ...
    * Defined in libs/langgraph/dist/channels/last_value.d.ts:14
...
[constructor](#constructor)[UpdateType](#UpdateType)[ValueType](#ValueType)[lc_graph_name](#lc_graph_name)[value](#value-2)[checkpoint](#checkpoint)[consume](#consume)[fromCheckpoint](#fromCheckpoint)[get](#get)[update](#update)
