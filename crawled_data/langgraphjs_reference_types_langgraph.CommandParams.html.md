---
url: https://langchain-ai.github.io/langgraphjs/reference/types/langgraph.CommandParams.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [CommandParams](langgraph.CommandParams.html)



# Type alias CommandParams<R>

CommandParams<[R](langgraph.CommandParams.html#R)>: { goto?: string | [Send](../classes/langgraph.Send.html) | (string | [Send](../classes/langgraph.Send.html))[]; graph?: string; resume?: [R](langgraph.CommandParams.html#R); update?: Record<string, unknown> | [string, unknown][]; }
...
#### Type declaration
  ...
  * ##### `Optional` goto?: string | [Send](../classes/langgraph.Send.html) | (string | [Send](../classes/langgraph.Send.html))[]
...
Graph to send the command to. Supported values are:
  ...
  * ##### `Optional` resume?: [R](langgraph.CommandParams.html#R)

Value to resume execution with. To be used together with [interrupt](../functions/langgraph.interrupt-1.html).
...
Update to apply to the graph's state.
  ...
  * Defined in libs/langgraph/dist/constants.d.ts:113
