---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/checkpoint.PutOperation.html
title: Untitled
date_crawled: 
---
...
interface PutOperation { [index](checkpoint.PutOperation.html#index)?: false | string[]; [key](checkpoint.PutOperation.html#key): string; [namespace](checkpoint.PutOperation.html#namespace): string[]; [value](checkpoint.PutOperation.html#value): null | Record<string, any>; }
...
```
// Index specific fieldsindex: ["metadata.title", "chapters[*].content"]// Disable indexingindex: false
Copy
```
...
```
// Root level documentsnamespace: ["documents"]// User-specific documentsnamespace: ["documents", "user123"]// Nested cache structurenamespace: ["cache", "docs", "v1"]
Copy
```
