---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.GraphBubbleUp.html
title: Untitled
date_crawled: 
---
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.GraphBubbleUp))
  ...
  * Defined in libs/langgraph/dist/errors.d.ts:9
...
[constructor](langgraph.GraphBubbleUp.html#constructor)

### Properties

[lc_error_code?](langgraph.GraphBubbleUp.html#lc_error_code) [message](langgraph.GraphBubbleUp.html#message) [name](langgraph.GraphBubbleUp.html#name) [stack?](langgraph.GraphBubbleUp.html#stack) [prepareStackTrace?](langgraph.GraphBubbleUp.html#prepareStackTrace) [stackTraceLimit](langgraph.GraphBubbleUp.html#stackTraceLimit)

### Accessors

[is_bubble_up](langgraph.GraphBubbleUp.html#is_bubble_up)

### Methods

[captureStackTrace](langgraph.GraphBubbleUp.html#captureStackTrace)

## Constructors

### constructor[](#constructor)

  * new GraphBubbleUp(message?, fields?): [GraphBubbleUp](langgraph.GraphBubbleUp.html)[](#constructor.new_GraphBubbleUp)
  * #### Parameters

    * `Optional` message: string
    * `Optional` fields: [BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html)

#### Returns [GraphBubbleUp](langgraph.GraphBubbleUp.html)

Inherited from [BaseLangGraphError](langgraph.BaseLangGraphError.html).[constructor](langgraph.BaseLangGraphError.html#constructor)

    * Defined in libs/langgraph/dist/errors.d.ts:7
...
[constructor](#constructor)[lc_error_code](#lc_error_code)[message](#message)[name](#name)[stack](#stack)[prepareStackTrace](#prepareStackTrace)[stackTraceLimit](#stackTraceLimit)[is_bubble_up](#is_bubble_up)[captureStackTrace](#captureStackTrace)
