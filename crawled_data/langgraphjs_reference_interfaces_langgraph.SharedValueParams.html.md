---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/langgraph.SharedValueParams.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [SharedValueParams](langgraph.SharedValueParams.html)



# Interface SharedValueParams

interface SharedValueParams { [key](langgraph.SharedValueParams.html#key): string; [scope](langgraph.SharedValueParams.html#scope): string; }

#### Hierarchy ([view full](../hierarchy.html#langgraph.SharedValueParams))

  * [ManagedValueParams](langgraph.ManagedValueParams.html)
    * SharedValueParams



  * Defined in libs/langgraph/dist/managed/shared_value.d.ts:7
...
[key](langgraph.SharedValueParams.html#key) [scope](langgraph.SharedValueParams.html#scope)
...
key: string
  ...
  * Defined in libs/langgraph/dist/managed/shared_value.d.ts:9
...
scope: string
  ...
  * Defined in libs/langgraph/dist/managed/shared_value.d.ts:8
