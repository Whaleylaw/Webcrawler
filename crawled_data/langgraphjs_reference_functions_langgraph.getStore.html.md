---
url: https://langchain-ai.github.io/langgraphjs/reference/functions/langgraph.getStore.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [getStore](langgraph.getStore.html)



# Function getStore

  * getStore(): [BaseStore](../classes/checkpoint.BaseStore.html) | undefined[](#getStore)
  * A helper utility function that returns the [BaseStore](../classes/checkpoint.BaseStore.html) that was set when the graph was initialized

#### Returns [BaseStore](../classes/checkpoint.BaseStore.html) | undefined

a reference to the [BaseStore](../classes/checkpoint.BaseStore.html) that was set when the graph was initialized

    * Defined in libs/langgraph/dist/pregel/utils/config.d.ts:10
