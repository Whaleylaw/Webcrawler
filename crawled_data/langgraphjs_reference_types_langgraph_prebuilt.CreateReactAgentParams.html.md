---
url: https://langchain-ai.github.io/langgraphjs/reference/types/langgraph_prebuilt.CreateReactAgentParams.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [CreateReactAgentParams](langgraph_prebuilt.CreateReactAgentParams.html)



# Type alias CreateReactAgentParams<A, StructuredResponseType>

CreateReactAgentParams<[A](langgraph_prebuilt.CreateReactAgentParams.html#A), [StructuredResponseType](langgraph_prebuilt.CreateReactAgentParams.html#StructuredResponseType)>: { checkpointSaver?: [BaseCheckpointSaver](../classes/checkpoint.BaseCheckpointSaver.html); checkpointer?: [BaseCheckpointSaver](../classes/checkpoint.BaseCheckpointSaver.html); interruptAfter?: N[] | [All](checkpoint.All.html); interruptBefore?: N[] | [All](checkpoint.All.html); llm: LanguageModelLike; messageModifier?: MessageModifier; name?: string; prompt?: Prompt; responseFormat?: z.ZodType<[StructuredResponseType](langgraph_prebuilt.CreateReactAgentParams.html#StructuredResponseType)> | StructuredResponseSchemaAndPrompt<[StructuredResponseType](langgraph_prebuilt.CreateReactAgentParams.html#StructuredResponseType)> | Record<string, any>; stateModifier?: StateModifier; stateSchema?: [A](langgraph_prebuilt.CreateReactAgentParams.html#A); store?: [BaseStore](../classes/checkpoint.BaseStore.html); tools: [ToolNode](../classes/langgraph_prebuilt.ToolNode.html) | (StructuredToolInterface | DynamicTool | RunnableToolLike)[]; }

#### Type Parameters

  * A extends [AnnotationRoot](../classes/langgraph.AnnotationRoot.html)<any> = [AnnotationRoot](../classes/langgraph.AnnotationRoot.html)<any>
...
#### Type declaration
  ...
  * ##### `Optional` checkpointSaver?: [BaseCheckpointSaver](../classes/checkpoint.BaseCheckpointSaver.html)

An optional checkpoint saver to persist the agent's state.

  * ##### `Optional` checkpointer?: [BaseCheckpointSaver](../classes/checkpoint.BaseCheckpointSaver.html)

An optional checkpoint saver to persist the agent's state. Alias of "checkpointSaver".

  * ##### `Optional` interruptAfter?: N[] | [All](checkpoint.All.html)

An optional list of node names to interrupt after running.

  * ##### `Optional` interruptBefore?: N[] | [All](checkpoint.All.html)
...
Note: Prior to `v0.2.46`, the prompt was set using `stateModifier` / `messagesModifier` parameters. This is now deprecated and will be removed in a future release.
  ...
  * ##### `Optional` responseFormat?: z.ZodType<[StructuredResponseType](langgraph_prebuilt.CreateReactAgentParams.html#StructuredResponseType)> | StructuredResponseSchemaAndPrompt<[StructuredResponseType](langgraph_prebuilt.CreateReactAgentParams.html#StructuredResponseType)> | Record<string, any>

An optional schema for the final agent output.

If provided, output will be formatted to match the given schema and returned in the 'structured_response' state key. If not provided, `structured_response` will not be present in the output state.
...
Use prompt instead.
  ...
  * ##### `Optional` stateSchema?: [A](langgraph_prebuilt.CreateReactAgentParams.html#A)

  * ##### `Optional` store?: [BaseStore](../classes/checkpoint.BaseStore.html)

  * ##### tools: [ToolNode](../classes/langgraph_prebuilt.ToolNode.html) | (StructuredToolInterface | DynamicTool | RunnableToolLike)[]
...
A list of tools or a ToolNode.
  ...
  * Defined in libs/langgraph/dist/prebuilt/react_agent_executor.d.ts:35
