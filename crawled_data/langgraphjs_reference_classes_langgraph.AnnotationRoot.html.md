---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.AnnotationRoot.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [AnnotationRoot](langgraph.AnnotationRoot.html)



# Class AnnotationRoot<SD>

Should not be instantiated directly. See [Annotation](../modules/langgraph.Annotation.html).

#### Type Parameters

  * SD extends [StateDefinition](../interfaces/langgraph.StateDefinition.html)



  * Defined in libs/langgraph/dist/graph/annotation.d.ts:37
...
[constructor](langgraph.AnnotationRoot.html#constructor)

### Properties

[Node](langgraph.AnnotationRoot.html#Node) [State](langgraph.AnnotationRoot.html#State) [Update](langgraph.AnnotationRoot.html#Update) [lc_graph_name](langgraph.AnnotationRoot.html#lc_graph_name) [spec](langgraph.AnnotationRoot.html#spec)

## Constructors

### constructor[](#constructor)

  * new AnnotationRoot<[SD](langgraph.AnnotationRoot.html#constructor.new_AnnotationRoot.SD-1)>(s): [AnnotationRoot](langgraph.AnnotationRoot.html)<[SD](langgraph.AnnotationRoot.html#constructor.new_AnnotationRoot.SD-1)>[](#constructor.new_AnnotationRoot)
  * #### Type Parameters
...
#### Parameters
    ...
    * s: [SD](langgraph.AnnotationRoot.html#constructor.new_AnnotationRoot.SD-1)

#### Returns [AnnotationRoot](langgraph.AnnotationRoot.html)<[SD](langgraph.AnnotationRoot.html#constructor.new_AnnotationRoot.SD-1)>

    * Defined in libs/langgraph/dist/graph/annotation.d.ts:43
...
Node: [NodeType](../types/langgraph.NodeType.html)<[SD](langgraph.AnnotationRoot.html#constructor.new_AnnotationRoot.SD-1)>

  * Defined in libs/langgraph/dist/graph/annotation.d.ts:41



### State[](#State)

State: [StateType](../types/langgraph.StateType.html)<[SD](langgraph.AnnotationRoot.html#constructor.new_AnnotationRoot.SD-1)>

  * Defined in libs/langgraph/dist/graph/annotation.d.ts:39



### Update[](#Update)

Update: [UpdateType](../types/langgraph.UpdateType.html)<[SD](langgraph.AnnotationRoot.html#constructor.new_AnnotationRoot.SD-1)>

  * Defined in libs/langgraph/dist/graph/annotation.d.ts:40
...
lc_graph_name: string
  ...
  * Defined in libs/langgraph/dist/graph/annotation.d.ts:38



### spec[](#spec)

spec: [SD](langgraph.AnnotationRoot.html#constructor.new_AnnotationRoot.SD-1)

  * Defined in libs/langgraph/dist/graph/annotation.d.ts:42
...
[constructor](#constructor)[Node](#Node)[State](#State)[Update](#Update)[lc_graph_name](#lc_graph_name)[spec](#spec)
