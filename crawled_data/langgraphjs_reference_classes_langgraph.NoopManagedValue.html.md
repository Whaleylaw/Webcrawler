---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.NoopManagedValue.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [NoopManagedValue](langgraph.NoopManagedValue.html)



# Class NoopManagedValue

No-op class used when getting state values, as managed values should never be returned in get state calls.

#### Hierarchy ([view full](../hierarchy.html#langgraph.NoopManagedValue))

  * [ManagedValue](langgraph.ManagedValue.html)
    * NoopManagedValue



  * Defined in libs/langgraph/dist/managed/base.d.ts:35
...
[constructor](langgraph.NoopManagedValue.html#constructor)

### Properties

[config](langgraph.NoopManagedValue.html#config) [lg_is_managed_value](langgraph.NoopManagedValue.html#lg_is_managed_value) [runtime](langgraph.NoopManagedValue.html#runtime)

### Methods

[addPromise](langgraph.NoopManagedValue.html#addPromise) [call](langgraph.NoopManagedValue.html#call) [promises](langgraph.NoopManagedValue.html#promises) [initialize](langgraph.NoopManagedValue.html#initialize)

## Constructors

### constructor[](#constructor)

  * new NoopManagedValue(config, _params?): [NoopManagedValue](langgraph.NoopManagedValue.html)[](#constructor.new_NoopManagedValue)
  * #### Parameters

    * config: RunnableConfig<Record<string, any>>
    * `Optional` _params: [ManagedValueParams](../interfaces/langgraph.ManagedValueParams.html)

#### Returns [NoopManagedValue](langgraph.NoopManagedValue.html)
...
### `Static` initialize[](#initialize)
  ...
  * initialize(config, _args?): Promise<[ManagedValue](langgraph.ManagedValue.html)<any>>[](#initialize.initialize-1)
  * #### Parameters

    * config: RunnableConfig<Record<string, any>>
    * `Optional` _args: any

#### Returns Promise<[ManagedValue](langgraph.ManagedValue.html)<any>>

Overrides [ManagedValue](langgraph.ManagedValue.html).[initialize](langgraph.ManagedValue.html#initialize)

    * Defined in libs/langgraph/dist/managed/base.d.ts:37
