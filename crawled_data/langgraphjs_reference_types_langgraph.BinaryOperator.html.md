---
url: https://langchain-ai.github.io/langgraphjs/reference/types/langgraph.BinaryOperator.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [BinaryOperator](langgraph.BinaryOperator.html)



# Type alias BinaryOperator<ValueType, UpdateType>

BinaryOperator<[ValueType](langgraph.BinaryOperator.html#ValueType), [UpdateType](langgraph.BinaryOperator.html#UpdateType)>: ((a, b) => [ValueType](langgraph.BinaryOperator.html#ValueType))
...
#### Type declaration
  ...
  *     * (a, b): [ValueType](langgraph.BinaryOperator.html#ValueType)
    * #### Parameters

      * a: [ValueType](langgraph.BinaryOperator.html#ValueType)
      * b: [UpdateType](langgraph.BinaryOperator.html#UpdateType)

#### Returns [ValueType](langgraph.BinaryOperator.html#ValueType)




  * Defined in libs/langgraph/dist/channels/binop.d.ts:2
