---
url: https://langchain-ai.github.io/langgraphjs/reference/types/langgraph.EntrypointOptions.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [EntrypointOptions](langgraph.EntrypointOptions.html)



# Type alias EntrypointOptions`Beta`

EntrypointOptions: { checkpointer?: [BaseCheckpointSaver](../classes/checkpoint.BaseCheckpointSaver.html); name: string; store?: [BaseStore](../classes/checkpoint.BaseStore.html); }

Options for the [entrypoint](../functions/langgraph.entrypoint.html) function

!!! warning "Beta" The Functional API is currently in beta and is subject to change.

#### Type declaration

  * ##### `Optional` `Beta` checkpointer?: [BaseCheckpointSaver](../classes/checkpoint.BaseCheckpointSaver.html)

The checkpointer for the [entrypoint](../functions/langgraph.entrypoint.html). Used to save and restore state between invocations of the workflow.

  * ##### `Beta` name: string

The name of the [entrypoint](../functions/langgraph.entrypoint.html), analogous to the node name in [StateGraph](../classes/langgraph.StateGraph.html). This name is used for logging, debugging, and checkpoint identification.

  * ##### `Optional` `Beta` store?: [BaseStore](../classes/checkpoint.BaseStore.html)

The store for the [entrypoint](../functions/langgraph.entrypoint.html). Used to persist data across workflow runs.




  * Defined in libs/langgraph/dist/func/index.d.ts:92
