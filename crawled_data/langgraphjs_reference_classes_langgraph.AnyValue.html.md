---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.AnyValue.html
title: Untitled
date_crawled: 
---
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.AnyValue))

  * [BaseChannel](langgraph.BaseChannel.html)<[Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1), [Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1), [Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)>
    * AnyValue



  * Defined in libs/langgraph/dist/channels/any_value.d.ts:10
...
[constructor](langgraph.AnyValue.html#constructor)

### Properties

[UpdateType](langgraph.AnyValue.html#UpdateType) [ValueType](langgraph.AnyValue.html#ValueType) [lc_graph_name](langgraph.AnyValue.html#lc_graph_name) [value](langgraph.AnyValue.html#value-2)

### Methods

[checkpoint](langgraph.AnyValue.html#checkpoint) [consume](langgraph.AnyValue.html#consume) [fromCheckpoint](langgraph.AnyValue.html#fromCheckpoint) [get](langgraph.AnyValue.html#get) [update](langgraph.AnyValue.html#update)

## Constructors

### constructor[](#constructor)

  * new AnyValue<[Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)>(): [AnyValue](langgraph.AnyValue.html)<[Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)>[](#constructor.new_AnyValue)
  * #### Type Parameters

    * Value

#### Returns [AnyValue](langgraph.AnyValue.html)<[Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)>

Overrides [BaseChannel](langgraph.BaseChannel.html).[constructor](langgraph.BaseChannel.html#constructor)

    * Defined in libs/langgraph/dist/channels/any_value.d.ts:13
...
UpdateType: [Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)
...
ValueType: [Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[lc_graph_name](langgraph.BaseChannel.html#lc_graph_name)
  ...
  * Defined in libs/langgraph/dist/channels/any_value.d.ts:11



### value[](#value-2)

value: [] | [[Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)]

  * Defined in libs/langgraph/dist/channels/any_value.d.ts:12
...
### checkpoint[](#checkpoint)
  ...
  * checkpoint(): [Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)[](#checkpoint.checkpoint-1)
  * Return a string representation of the channel's current state.

#### Returns [Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[checkpoint](langgraph.BaseChannel.html#checkpoint)
    ...
    * Defined in libs/langgraph/dist/channels/any_value.d.ts:17
...
#### Parameters
    ...
    * `Optional` checkpoint: [Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)

#### Returns this

Overrides [BaseChannel](langgraph.BaseChannel.html).[fromCheckpoint](langgraph.BaseChannel.html#fromCheckpoint)

    * Defined in libs/langgraph/dist/channels/any_value.d.ts:14



### get[](#get)

  * get(): [Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)[](#get.get-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[get](langgraph.BaseChannel.html#get)
    ...
    * Defined in libs/langgraph/dist/channels/any_value.d.ts:16
...
#### Parameters
    ...
    * values: [Value](langgraph.AnyValue.html#constructor.new_AnyValue.Value-1)[]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[update](langgraph.BaseChannel.html#update)
    ...
    * Defined in libs/langgraph/dist/channels/any_value.d.ts:15
