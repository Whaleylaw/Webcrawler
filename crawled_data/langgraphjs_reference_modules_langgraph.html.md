...
# Module langgraph
  ...
  * Defined in libs/langgraph/index.d.ts:1
...
[AsyncBatchedStore](langgraph.html#AsyncBatchedStore) [BaseCheckpointSaver](langgraph.html#BaseCheckpointSaver) [BaseStore](langgraph.html#BaseStore) [Checkpoint](langgraph.html#Checkpoint) [CheckpointMetadata](langgraph.html#CheckpointMetadata) [CheckpointTuple](langgraph.html#CheckpointTuple) [GetOperation](langgraph.html#GetOperation) [InMemoryStore](langgraph.html#InMemoryStore) [Item](langgraph.html#Item) [ListNamespacesOperation](langgraph.html#ListNamespacesOperation) [MatchCondition](langgraph.html#MatchCondition) [MemorySaver](langgraph.html#MemorySaver) [NameSpacePath](langgraph.html#NameSpacePath) [NamespaceMatchType](langgraph.html#NamespaceMatchType) [Operation](langgraph.html#Operation) [OperationResults](langgraph.html#OperationResults) [PutOperation](langgraph.html#PutOperation) [SearchOperation](langgraph.html#SearchOperation) [addMessages](langgraph.html#addMessages)
...
[AnnotationRoot](../classes/langgraph.AnnotationRoot.html) [AnyValue](../classes/langgraph.AnyValue.html) [BaseChannel](../classes/langgraph.BaseChannel.html) [BaseLangGraphError](../classes/langgraph.BaseLangGraphError.html) [BinaryOperatorAggregate](../classes/langgraph.BinaryOperatorAggregate.html) [Command](../classes/langgraph.Command.html) [CompiledGraph](../classes/langgraph.CompiledGraph.html) [CompiledStateGraph](../classes/langgraph.CompiledStateGraph.html) [DynamicBarrierValue](../classes/langgraph.DynamicBarrierValue.html) [EmptyChannelError](../classes/langgraph.EmptyChannelError.html) [EmptyInputError](../classes/langgraph.EmptyInputError.html) [EphemeralValue](../classes/langgraph.EphemeralValue.html) [Graph](../classes/langgraph.Graph.html) [GraphBubbleUp](../classes/langgraph.GraphBubbleUp.html) [GraphInterrupt](../classes/langgraph.GraphInterrupt.html) [GraphRecursionError](../classes/langgraph.GraphRecursionError.html) [GraphValueError](../classes/langgraph.GraphValueError.html) [InvalidUpdateError](../classes/langgraph.InvalidUpdateError.html) [IsLastStepManager](../classes/langgraph.IsLastStepManager.html) [LastValue](../classes/langgraph.LastValue.html) [ManagedValue](../classes/langgraph.ManagedValue.html) [ManagedValueMapping](../classes/langgraph.ManagedValueMapping.html) [MultipleSubgraphsError](../classes/langgraph.MultipleSubgraphsError.html) [NamedBarrierValue](../classes/langgraph.NamedBarrierValue.html) [NodeInterrupt](../classes/langgraph.NodeInterrupt.html) [NoopManagedValue](../classes/langgraph.NoopManagedValue.html) [ParentCommand](../classes/langgraph.ParentCommand.html) [Pregel](../classes/langgraph.Pregel.html) [PregelNode](../classes/langgraph.PregelNode.html) [RemoteException](../classes/langgraph.RemoteException.html) [Send](../classes/langgraph.Send.html) [SharedValue](../classes/langgraph.SharedValue.html) [StateGraph](../classes/langgraph.StateGraph.html) [Topic](../classes/langgraph.Topic.html) [UnreachableNodeError](../classes/langgraph.UnreachableNodeError.html) [WritableManagedValue](../classes/langgraph.WritableManagedValue.html)

### Interfaces

[ConfiguredManagedValue](../interfaces/langgraph.ConfiguredManagedValue.html) [LangGraphRunnableConfig](../interfaces/langgraph.LangGraphRunnableConfig.html) [ManagedValueParams](../interfaces/langgraph.ManagedValueParams.html) [PregelOptions](../interfaces/langgraph.PregelOptions.html) [SharedValueParams](../interfaces/langgraph.SharedValueParams.html) [StateDefinition](../interfaces/langgraph.StateDefinition.html) [StateGraphArgs](../interfaces/langgraph.StateGraphArgs.html) [StateSnapshot](../interfaces/langgraph.StateSnapshot.html) [WaitForNames](../interfaces/langgraph.WaitForNames.html)

### Type Aliases

[BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html) [BinaryOperator](../types/langgraph.BinaryOperator.html) [CommandParams](../types/langgraph.CommandParams.html) [EntrypointOptions](../types/langgraph.EntrypointOptions.html) [Interrupt](../types/langgraph.Interrupt.html) [ManagedValueSpec](../types/langgraph.ManagedValueSpec.html) [Messages](../types/langgraph.Messages.html) [NodeType](../types/langgraph.NodeType.html) [PregelParams](../types/langgraph.PregelParams.html) [RetryPolicy](../types/langgraph.RetryPolicy.html) [SingleReducer](../types/langgraph.SingleReducer.html) [StateType](../types/langgraph.StateType.html) [StreamMode](../types/langgraph.StreamMode.html) [TaskOptions](../types/langgraph.TaskOptions.html) [UpdateType](../types/langgraph.UpdateType.html)

### Variables

[ChannelKeyPlaceholder](../variables/langgraph.ChannelKeyPlaceholder.html) [END](../variables/langgraph.END.html) [MessagesAnnotation](../variables/langgraph.MessagesAnnotation.html) [START](../variables/langgraph.START.html)

### Functions

[entrypoint](../functions/langgraph.entrypoint.html) [getPreviousState](../functions/langgraph.getPreviousState.html) [getStore](../functions/langgraph.getStore.html) [getSubgraphsSeenSet](../functions/langgraph.getSubgraphsSeenSet.html) [getWriter](../functions/langgraph.getWriter.html) [interrupt](../functions/langgraph.interrupt-1.html) [isCommand](../functions/langgraph.isCommand.html) [isConfiguredManagedValue](../functions/langgraph.isConfiguredManagedValue.html) [isGraphBubbleUp](../functions/langgraph.isGraphBubbleUp.html) [isGraphInterrupt](../functions/langgraph.isGraphInterrupt.html) [isManagedValue](../functions/langgraph.isManagedValue.html) [isParentCommand](../functions/langgraph.isParentCommand.html) [messagesStateReducer](../functions/langgraph.messagesStateReducer.html) [task](../functions/langgraph.task.html)

## References

### AsyncBatchedStore[](#AsyncBatchedStore)

Re-exports [AsyncBatchedStore](../classes/checkpoint.AsyncBatchedStore.html)

### BaseCheckpointSaver[](#BaseCheckpointSaver)

Re-exports [BaseCheckpointSaver](../classes/checkpoint.BaseCheckpointSaver.html)

### BaseStore[](#BaseStore)

Re-exports [BaseStore](../classes/checkpoint.BaseStore.html)

### Checkpoint[](#Checkpoint)

Re-exports [Checkpoint](../interfaces/checkpoint.Checkpoint.html)

### CheckpointMetadata[](#CheckpointMetadata)

Re-exports [CheckpointMetadata](../interfaces/checkpoint.CheckpointMetadata.html)

### CheckpointTuple[](#CheckpointTuple)

Re-exports [CheckpointTuple](../interfaces/checkpoint.CheckpointTuple.html)

### GetOperation[](#GetOperation)

Re-exports [GetOperation](../interfaces/checkpoint.GetOperation.html)

### InMemoryStore[](#InMemoryStore)

Re-exports [InMemoryStore](../classes/checkpoint.InMemoryStore.html)

### Item[](#Item)

Re-exports [Item](../interfaces/checkpoint.Item.html)

### ListNamespacesOperation[](#ListNamespacesOperation)

Re-exports [ListNamespacesOperation](../interfaces/checkpoint.ListNamespacesOperation.html)

### MatchCondition[](#MatchCondition)

Re-exports [MatchCondition](../interfaces/checkpoint.MatchCondition.html)

### MemorySaver[](#MemorySaver)

Re-exports [MemorySaver](../classes/checkpoint.MemorySaver.html)

### NameSpacePath[](#NameSpacePath)

Re-exports [NameSpacePath](../types/checkpoint.NameSpacePath.html)

### NamespaceMatchType[](#NamespaceMatchType)

Re-exports [NamespaceMatchType](../types/checkpoint.NamespaceMatchType.html)

### Operation[](#Operation)

Re-exports [Operation](../types/checkpoint.Operation.html)

### OperationResults[](#OperationResults)

Re-exports [OperationResults](../types/checkpoint.OperationResults.html)

### PutOperation[](#PutOperation)

Re-exports [PutOperation](../interfaces/checkpoint.PutOperation.html)

### SearchOperation[](#SearchOperation)

Re-exports [SearchOperation](../interfaces/checkpoint.SearchOperation.html)

### addMessages[](#addMessages)

Renames and re-exports [messagesStateReducer](../functions/langgraph.messagesStateReducer.html)
...
[AsyncBatchedStore](#AsyncBatchedStore)[BaseCheckpointSaver](#BaseCheckpointSaver)[BaseStore](#BaseStore)[Checkpoint](#Checkpoint)[CheckpointMetadata](#CheckpointMetadata)[CheckpointTuple](#CheckpointTuple)[GetOperation](#GetOperation)[InMemoryStore](#InMemoryStore)[Item](#Item)[ListNamespacesOperation](#ListNamespacesOperation)[MatchCondition](#MatchCondition)[MemorySaver](#MemorySaver)[NameSpacePath](#NameSpacePath)[NamespaceMatchType](#NamespaceMatchType)[Operation](#Operation)[OperationResults](#OperationResults)[PutOperation](#PutOperation)[SearchOperation](#SearchOperation)[addMessages](#addMessages)
