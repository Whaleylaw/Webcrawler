---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/checkpoint.CheckpointTuple.html
title: Untitled
date_crawled: 
---
...
interface CheckpointTuple { [checkpoint](checkpoint.CheckpointTuple.html#checkpoint): [Checkpoint](checkpoint.Checkpoint.html)<string, string>; [config](checkpoint.CheckpointTuple.html#config): RunnableConfig<Record<string, any>>; [metadata](checkpoint.CheckpointTuple.html#metadata)?: [CheckpointMetadata](checkpoint.CheckpointMetadata.html); [parentConfig](checkpoint.CheckpointTuple.html#parentConfig)?: RunnableConfig<Record<string, any>>; [pendingWrites](checkpoint.CheckpointTuple.html#pendingWrites)?: [string, string, unknown][]; }
...
### `Optional` parentConfig[](#parentConfig)
...
### `Optional` pendingWrites[](#pendingWrites)
