---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/checkpoint.BaseCheckpointSaver.html
title: Untitled
date_crawled: 
---
...
#### Hierarchy ([view full](../hierarchy.html#checkpoint.BaseCheckpointSaver))

  * BaseCheckpointSaver
    * [MemorySaver](checkpoint.MemorySaver.html)
  ...
  * Defined in libs/checkpoint/dist/base.d.ts:60
...
[constructor](checkpoint.BaseCheckpointSaver.html#constructor)

### Properties

[serde](checkpoint.BaseCheckpointSaver.html#serde)

### Methods

[get](checkpoint.BaseCheckpointSaver.html#get) [getNextVersion](checkpoint.BaseCheckpointSaver.html#getNextVersion) [getTuple](checkpoint.BaseCheckpointSaver.html#getTuple) [list](checkpoint.BaseCheckpointSaver.html#list) [put](checkpoint.BaseCheckpointSaver.html#put) [putWrites](checkpoint.BaseCheckpointSaver.html#putWrites)

## Constructors

### constructor[](#constructor)

  * new BaseCheckpointSaver<[V](checkpoint.BaseCheckpointSaver.html#constructor.new_BaseCheckpointSaver.V-1)>(serde?): [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html)<[V](checkpoint.BaseCheckpointSaver.html#constructor.new_BaseCheckpointSaver.V-1)>[](#constructor.new_BaseCheckpointSaver)
  * #### Type Parameters
...
#### Returns [BaseCheckpointSaver](checkpoint.BaseCheckpointSaver.html)<[V](checkpoint.BaseCheckpointSaver.html#constructor.new_BaseCheckpointSaver.V-1)>

    * Defined in libs/checkpoint/dist/base.d.ts:62
...
### getNextVersion[](#getNextVersion)
  ...
  * getNextVersion(current, _channel): [V](checkpoint.BaseCheckpointSaver.html#constructor.new_BaseCheckpointSaver.V-1)[](#getNextVersion.getNextVersion-1)
...
#### Parameters
    ...
    * current: undefined | [V](checkpoint.BaseCheckpointSaver.html#constructor.new_BaseCheckpointSaver.V-1)
    * _channel: [ChannelProtocol](../interfaces/checkpoint.ChannelProtocol.html)<unknown, unknown, unknown>

#### Returns [V](checkpoint.BaseCheckpointSaver.html#constructor.new_BaseCheckpointSaver.V-1)

    * Defined in libs/checkpoint/dist/base.d.ts:77



### `Abstract` getTuple[](#getTuple)
...
#### Returns Promise<undefined | [CheckpointTuple](../interfaces/checkpoint.CheckpointTuple.html)>
    ...
    * Defined in libs/checkpoint/dist/base.d.ts:64
...
#### Returns AsyncGenerator<[CheckpointTuple](../interfaces/checkpoint.CheckpointTuple.html), any, unknown>
    ...
    * Defined in libs/checkpoint/dist/base.d.ts:65
...
#### Returns Promise<RunnableConfig<Record<string, any>>>
    ...
    * Defined in libs/checkpoint/dist/base.d.ts:66



### `Abstract` putWrites[](#putWrites)
...
#### Returns Promise<void>
    ...
    * Defined in libs/checkpoint/dist/base.d.ts:70
...
[constructor](#constructor)[serde](#serde)[get](#get)[getNextVersion](#getNextVersion)[getTuple](#getTuple)[list](#list)[put](#put)[putWrites](#putWrites)
