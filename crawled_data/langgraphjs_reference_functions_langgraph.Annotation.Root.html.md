---
url: https://langchain-ai.github.io/langgraphjs/reference/functions/langgraph.Annotation.Root.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [Root](langgraph.Annotation.Root.html)



# Function Root

  * Root<[S](langgraph.Annotation.Root.html#Root.S)>(sd): [AnnotationRoot](../classes/langgraph.AnnotationRoot.html)<[S](langgraph.Annotation.Root.html#Root.S)>[](#Root)
  * Helper function that instantiates a StateGraph state. See [Annotation](../modules/langgraph.Annotation.html) for usage.

#### Type Parameters

    * S extends [StateDefinition](../interfaces/langgraph.StateDefinition.html)

#### Parameters

    * sd: [S](langgraph.Annotation.Root.html#Root.S)

#### Returns [AnnotationRoot](../classes/langgraph.AnnotationRoot.html)<[S](langgraph.Annotation.Root.html#Root.S)>

    * Defined in libs/langgraph/dist/graph/annotation.d.ts:32
