---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.InvalidUpdateError.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [InvalidUpdateError](langgraph.InvalidUpdateError.html)



# Class InvalidUpdateError

#### Hierarchy ([view full](../hierarchy.html#langgraph.InvalidUpdateError))
  ...
  * Defined in libs/langgraph/dist/errors.d.ts:46
...
[constructor](langgraph.InvalidUpdateError.html#constructor)

### Properties

[lc_error_code?](langgraph.InvalidUpdateError.html#lc_error_code) [message](langgraph.InvalidUpdateError.html#message) [name](langgraph.InvalidUpdateError.html#name) [stack?](langgraph.InvalidUpdateError.html#stack) [prepareStackTrace?](langgraph.InvalidUpdateError.html#prepareStackTrace) [stackTraceLimit](langgraph.InvalidUpdateError.html#stackTraceLimit)

### Accessors

[unminifiable_name](langgraph.InvalidUpdateError.html#unminifiable_name)

### Methods

[captureStackTrace](langgraph.InvalidUpdateError.html#captureStackTrace)

## Constructors

### constructor[](#constructor)

  * new InvalidUpdateError(message?, fields?): [InvalidUpdateError](langgraph.InvalidUpdateError.html)[](#constructor.new_InvalidUpdateError)
  * #### Parameters

    * `Optional` message: string
    * `Optional` fields: [BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html)

#### Returns [InvalidUpdateError](langgraph.InvalidUpdateError.html)

Overrides [BaseLangGraphError](langgraph.BaseLangGraphError.html).[constructor](langgraph.BaseLangGraphError.html#constructor)

    * Defined in libs/langgraph/dist/errors.d.ts:47
...
### `Static` unminifiable_name[](#unminifiable_name)
  ...
  * #### Returns string
    ...
    * Defined in libs/langgraph/dist/errors.d.ts:48
