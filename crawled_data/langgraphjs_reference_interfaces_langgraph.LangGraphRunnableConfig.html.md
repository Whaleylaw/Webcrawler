---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/langgraph.LangGraphRunnableConfig.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [LangGraphRunnableConfig](langgraph.LangGraphRunnableConfig.html)



# Interface LangGraphRunnableConfig<ConfigurableType>

interface LangGraphRunnableConfig<[ConfigurableType](langgraph.LangGraphRunnableConfig.html#ConfigurableType)> { [callbacks](langgraph.LangGraphRunnableConfig.html#callbacks)?: Callbacks; [configurable](langgraph.LangGraphRunnableConfig.html#configurable)?: [ConfigurableType](langgraph.LangGraphRunnableConfig.html#ConfigurableType); [maxConcurrency](langgraph.LangGraphRunnableConfig.html#maxConcurrency)?: number; [metadata](langgraph.LangGraphRunnableConfig.html#metadata)?: Record<string, unknown>; [recursionLimit](langgraph.LangGraphRunnableConfig.html#recursionLimit)?: number; [runId](langgraph.LangGraphRunnableConfig.html#runId)?: string; [runName](langgraph.LangGraphRunnableConfig.html#runName)?: string; [signal](langgraph.LangGraphRunnableConfig.html#signal)?: AbortSignal; [store](langgraph.LangGraphRunnableConfig.html#store)?: [BaseStore](../classes/checkpoint.BaseStore.html); [tags](langgraph.LangGraphRunnableConfig.html#tags)?: string[]; [timeout](langgraph.LangGraphRunnableConfig.html#timeout)?: number; [writer](langgraph.LangGraphRunnableConfig.html#writer)?: ((chunk) => void); }
...
#### Hierarchy
  ...
  * RunnableConfig<[ConfigurableType](langgraph.LangGraphRunnableConfig.html#ConfigurableType)>
    * LangGraphRunnableConfig



  * Defined in libs/langgraph/dist/pregel/runnable_types.d.ts:3
...
[callbacks?](langgraph.LangGraphRunnableConfig.html#callbacks) [configurable?](langgraph.LangGraphRunnableConfig.html#configurable) [maxConcurrency?](langgraph.LangGraphRunnableConfig.html#maxConcurrency) [metadata?](langgraph.LangGraphRunnableConfig.html#metadata) [recursionLimit?](langgraph.LangGraphRunnableConfig.html#recursionLimit) [runId?](langgraph.LangGraphRunnableConfig.html#runId) [runName?](langgraph.LangGraphRunnableConfig.html#runName) [signal?](langgraph.LangGraphRunnableConfig.html#signal) [store?](langgraph.LangGraphRunnableConfig.html#store) [tags?](langgraph.LangGraphRunnableConfig.html#tags) [timeout?](langgraph.LangGraphRunnableConfig.html#timeout) [writer?](langgraph.LangGraphRunnableConfig.html#writer)
...
configurable?: [ConfigurableType](langgraph.LangGraphRunnableConfig.html#ConfigurableType)
...
store?: [BaseStore](../classes/checkpoint.BaseStore.html)
  ...
  * Defined in libs/langgraph/dist/pregel/runnable_types.d.ts:4
...
#### Returns void
  ...
  * Defined in libs/langgraph/dist/pregel/runnable_types.d.ts:5
...
[callbacks](#callbacks)[configurable](#configurable)[maxConcurrency](#maxConcurrency)[metadata](#metadata)[recursionLimit](#recursionLimit)[runId](#runId)[runName](#runName)[signal](#signal)[store](#store)[tags](#tags)[timeout](#timeout)[writer](#writer)
