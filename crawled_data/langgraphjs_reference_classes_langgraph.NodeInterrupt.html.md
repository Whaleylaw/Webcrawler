---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.NodeInterrupt.html
title: Untitled
date_crawled: 
---
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.NodeInterrupt))
  ...
  * Defined in libs/langgraph/dist/errors.d.ts:26
...
[constructor](langgraph.NodeInterrupt.html#constructor)

### Properties

[interrupts](langgraph.NodeInterrupt.html#interrupts) [lc_error_code?](langgraph.NodeInterrupt.html#lc_error_code) [message](langgraph.NodeInterrupt.html#message) [name](langgraph.NodeInterrupt.html#name) [stack?](langgraph.NodeInterrupt.html#stack) [prepareStackTrace?](langgraph.NodeInterrupt.html#prepareStackTrace) [stackTraceLimit](langgraph.NodeInterrupt.html#stackTraceLimit)

### Accessors

[is_bubble_up](langgraph.NodeInterrupt.html#is_bubble_up) [unminifiable_name](langgraph.NodeInterrupt.html#unminifiable_name)

### Methods

[captureStackTrace](langgraph.NodeInterrupt.html#captureStackTrace)

## Constructors

### constructor[](#constructor)

  * new NodeInterrupt(message, fields?): [NodeInterrupt](langgraph.NodeInterrupt.html)[](#constructor.new_NodeInterrupt)
  * #### Parameters

    * message: any
    * `Optional` fields: [BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html)

#### Returns [NodeInterrupt](langgraph.NodeInterrupt.html)

Overrides [GraphInterrupt](langgraph.GraphInterrupt.html).[constructor](langgraph.GraphInterrupt.html#constructor)

    * Defined in libs/langgraph/dist/errors.d.ts:27
...
Inherited from [GraphInterrupt](langgraph.GraphInterrupt.html).[interrupts](langgraph.GraphInterrupt.html#interrupts)
...
Inherited from [GraphInterrupt](langgraph.GraphInterrupt.html).[lc_error_code](langgraph.GraphInterrupt.html#lc_error_code)
...
Inherited from [GraphInterrupt](langgraph.GraphInterrupt.html).[message](langgraph.GraphInterrupt.html#message)
...
Inherited from [GraphInterrupt](langgraph.GraphInterrupt.html).[name](langgraph.GraphInterrupt.html#name)
...
Inherited from [GraphInterrupt](langgraph.GraphInterrupt.html).[stack](langgraph.GraphInterrupt.html#stack)
...
Inherited from [GraphInterrupt](langgraph.GraphInterrupt.html).[prepareStackTrace](langgraph.GraphInterrupt.html#prepareStackTrace)
...
Inherited from [GraphInterrupt](langgraph.GraphInterrupt.html).[stackTraceLimit](langgraph.GraphInterrupt.html#stackTraceLimit)
...
Inherited from GraphInterrupt.is_bubble_up
...
Overrides GraphInterrupt.unminifiable_name

    * Defined in libs/langgraph/dist/errors.d.ts:28
...
Inherited from [GraphInterrupt](langgraph.GraphInterrupt.html).[captureStackTrace](langgraph.GraphInterrupt.html#captureStackTrace)
...
[constructor](#constructor)[interrupts](#interrupts)[lc_error_code](#lc_error_code)[message](#message)[name](#name)[stack](#stack)[prepareStackTrace](#prepareStackTrace)[stackTraceLimit](#stackTraceLimit)[is_bubble_up](#is_bubble_up)[unminifiable_name](#unminifiable_name)[captureStackTrace](#captureStackTrace)
