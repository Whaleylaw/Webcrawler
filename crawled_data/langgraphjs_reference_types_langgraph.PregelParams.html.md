---
url: https://langchain-ai.github.io/langgraphjs/reference/types/langgraph.PregelParams.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [PregelParams](langgraph.PregelParams.html)



# Type alias PregelParams<Nn, Cc>`Internal`

PregelParams<[Nn](langgraph.PregelParams.html#Nn), [Cc](langgraph.PregelParams.html#Cc)>: { autoValidate?: boolean; channels: [Cc](langgraph.PregelParams.html#Cc); checkpointer?: [BaseCheckpointSaver](../classes/checkpoint.BaseCheckpointSaver.html) | false; config?: [LangGraphRunnableConfig](../interfaces/langgraph.LangGraphRunnableConfig.html); debug?: boolean; inputChannels: keyof [Cc](langgraph.PregelParams.html#Cc) | (keyof [Cc](langgraph.PregelParams.html#Cc))[]; interruptAfter?: (keyof [Nn](langgraph.PregelParams.html#Nn))[] | [All](checkpoint.All.html); interruptBefore?: (keyof [Nn](langgraph.PregelParams.html#Nn))[] | [All](checkpoint.All.html); name?: string; nodes: [Nn](langgraph.PregelParams.html#Nn); outputChannels: keyof [Cc](langgraph.PregelParams.html#Cc) | (keyof [Cc](langgraph.PregelParams.html#Cc))[]; retryPolicy?: [RetryPolicy](langgraph.RetryPolicy.html); stepTimeout?: number; store?: [BaseStore](../classes/checkpoint.BaseStore.html); streamChannels?: keyof [Cc](langgraph.PregelParams.html#Cc) | (keyof [Cc](langgraph.PregelParams.html#Cc))[]; streamMode?: [StreamMode](langgraph.StreamMode.html) | [StreamMode](langgraph.StreamMode.html)[]; }
...
#### Type Parameters
  ...
  * Cc extends StrRecord<string, [BaseChannel](../classes/langgraph.BaseChannel.html) | [ManagedValueSpec](langgraph.ManagedValueSpec.html)>
...
```
  ...
  * ##### channels: [Cc](langgraph.PregelParams.html#Cc)

The channels in the graph.

  * ##### `Optional` checkpointer?: [BaseCheckpointSaver](../classes/checkpoint.BaseCheckpointSaver.html) | false

The [checkpointer](../classes/checkpoint.BaseCheckpointSaver.html) to use for the graph run.

  * ##### `Optional` config?: [LangGraphRunnableConfig](../interfaces/langgraph.LangGraphRunnableConfig.html)
...
```
  ...
  * ##### inputChannels: keyof [Cc](langgraph.PregelParams.html#Cc) | (keyof [Cc](langgraph.PregelParams.html#Cc))[]

The input channels for the graph run.

  * ##### `Optional` interruptAfter?: (keyof [Nn](langgraph.PregelParams.html#Nn))[] | [All](checkpoint.All.html)

After processing one of the nodes named in this list, the graph will be interrupted and a resume [Command](../classes/langgraph.Command.html) must be provided to proceed with the execution of this thread.
...
```
  ...
  * ##### `Optional` interruptBefore?: (keyof [Nn](langgraph.PregelParams.html#Nn))[] | [All](checkpoint.All.html)

Before processing one of the nodes named in this list, the graph will be interrupted and a resume [Command](../classes/langgraph.Command.html) must be provided to proceed with the execution of this thread.
...
Runnable.name
  ...
  * ##### nodes: [Nn](langgraph.PregelParams.html#Nn)

The nodes in the graph.

  * ##### outputChannels: keyof [Cc](langgraph.PregelParams.html#Cc) | (keyof [Cc](langgraph.PregelParams.html#Cc))[]

The output channels for the graph run.

  * ##### `Optional` retryPolicy?: [RetryPolicy](langgraph.RetryPolicy.html)

The default retry policy for this graph. For defaults, see [RetryPolicy](langgraph.RetryPolicy.html).
...
```
  ...
  * ##### `Optional` store?: [BaseStore](../classes/checkpoint.BaseStore.html)

Memory store to use for SharedValues.

  * ##### `Optional` streamChannels?: keyof [Cc](langgraph.PregelParams.html#Cc) | (keyof [Cc](langgraph.PregelParams.html#Cc))[]
...
```
  ...
  * ##### `Optional` streamMode?: [StreamMode](langgraph.StreamMode.html) | [StreamMode](langgraph.StreamMode.html)[]
...
```
  ...
  * Defined in libs/langgraph/dist/pregel/types.d.ts:68
