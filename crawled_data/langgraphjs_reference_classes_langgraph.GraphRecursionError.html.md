---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.GraphRecursionError.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [GraphRecursionError](langgraph.GraphRecursionError.html)



# Class GraphRecursionError

#### Hierarchy ([view full](../hierarchy.html#langgraph.GraphRecursionError))
  ...
  * Defined in libs/langgraph/dist/errors.d.ts:12
...
[constructor](langgraph.GraphRecursionError.html#constructor)

### Properties

[lc_error_code?](langgraph.GraphRecursionError.html#lc_error_code) [message](langgraph.GraphRecursionError.html#message) [name](langgraph.GraphRecursionError.html#name) [stack?](langgraph.GraphRecursionError.html#stack) [prepareStackTrace?](langgraph.GraphRecursionError.html#prepareStackTrace) [stackTraceLimit](langgraph.GraphRecursionError.html#stackTraceLimit)

### Accessors

[unminifiable_name](langgraph.GraphRecursionError.html#unminifiable_name)

### Methods

[captureStackTrace](langgraph.GraphRecursionError.html#captureStackTrace)

## Constructors

### constructor[](#constructor)

  * new GraphRecursionError(message?, fields?): [GraphRecursionError](langgraph.GraphRecursionError.html)[](#constructor.new_GraphRecursionError)
  * #### Parameters

    * `Optional` message: string
    * `Optional` fields: [BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html)

#### Returns [GraphRecursionError](langgraph.GraphRecursionError.html)

Overrides [BaseLangGraphError](langgraph.BaseLangGraphError.html).[constructor](langgraph.BaseLangGraphError.html#constructor)

    * Defined in libs/langgraph/dist/errors.d.ts:13
...
### `Static` unminifiable_name[](#unminifiable_name)
  ...
  * #### Returns string
    ...
    * Defined in libs/langgraph/dist/errors.d.ts:14
