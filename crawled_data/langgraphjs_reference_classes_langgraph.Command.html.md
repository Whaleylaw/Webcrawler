---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.Command.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [Command](langgraph.Command.html)
...
```
import { Annotation, Command } from"@langchain/langgraph";// Define graph stateconstStateAnnotation = Annotation.Root({foo:Annotation<string>,});// Define the nodesconstnodeA = async (_state: typeofStateAnnotation.State) => {console.log("Called A");// this is a replacement for a real conditional edge functionconstgoto = Math.random() > .5 ? "nodeB" : "nodeC";// note how Command allows you to BOTH update the graph state AND route to the next nodereturnnewCommand({// this is the state updateupdate: {foo:"a",  },// this is a replacement for an edgegoto, });};// Nodes B and C are unchangedconstnodeB = async (state: typeofStateAnnotation.State) => {console.log("Called B");return {foo:state.foo + "|b", };}constnodeC = async (state: typeofStateAnnotation.State) => {console.log("Called C");return {foo:state.foo + "|c", };}import { StateGraph } from"@langchain/langgraph";// NOTE: there are no edges between nodes A, B and C!constgraph = newStateGraph(StateAnnotation) .addNode("nodeA", nodeA, {ends: ["nodeB", "nodeC"], }) .addNode("nodeB", nodeB) .addNode("nodeC", nodeC) .addEdge("__start__", "nodeA") .compile();awaitgraph.invoke({ foo:"" });// Randomly oscillates between// { foo: 'a|c' } and { foo: 'a|b' }
Copy
```
...
#### Type Parameters
  ...
  * Defined in libs/langgraph/dist/constants.d.ts:199
...
[constructor](langgraph.Command.html#constructor)

### Properties

[goto](langgraph.Command.html#goto) [graph?](langgraph.Command.html#graph) [lc_direct_tool_output](langgraph.Command.html#lc_direct_tool_output) [lg_name](langgraph.Command.html#lg_name) [resume?](langgraph.Command.html#resume) [update?](langgraph.Command.html#update) [PARENT](langgraph.Command.html#PARENT)

### Methods

[_updateAsTuples](langgraph.Command.html#_updateAsTuples) [toJSON](langgraph.Command.html#toJSON)

## Constructors

### constructor[](#constructor)

  * new Command<[R](langgraph.Command.html#constructor.new_Command.R-1)>(args): [Command](langgraph.Command.html)<[R](langgraph.Command.html#constructor.new_Command.R-1)>[](#constructor.new_Command)
  * #### Type Parameters
...
#### Parameters
    ...
    * args: [CommandParams](../types/langgraph.CommandParams.html)<[R](langgraph.Command.html#constructor.new_Command.R-1)>

#### Returns [Command](langgraph.Command.html)<[R](langgraph.Command.html#constructor.new_Command.R-1)>

    * Defined in libs/langgraph/dist/constants.d.ts:207
...
goto: string | [Send](langgraph.Send.html) | (string | [Send](langgraph.Send.html))[]

  * Defined in libs/langgraph/dist/constants.d.ts:205
...
graph?: string
  ...
  * Defined in libs/langgraph/dist/constants.d.ts:202



### lc_direct_tool_output[](#lc_direct_tool_output)

lc_direct_tool_output: boolean

  * Defined in libs/langgraph/dist/constants.d.ts:201
...
lg_name: string
  ...
  * Defined in libs/langgraph/dist/constants.d.ts:200



### `Optional` resume[](#resume)

resume?: [R](langgraph.Command.html#constructor.new_Command.R-1)

  * Defined in libs/langgraph/dist/constants.d.ts:204
...
update?: Record<string, unknown> | [string, unknown][]
  ...
  * Defined in libs/langgraph/dist/constants.d.ts:203
...
PARENT: string
  ...
  * Defined in libs/langgraph/dist/constants.d.ts:206



## Methods

### _updateAsTuples[](#_updateAsTuples)

  * _updateAsTuples(): [string, unknown][][](#_updateAsTuples._updateAsTuples-1)
  * #### Returns [string, unknown][]

    * Defined in libs/langgraph/dist/constants.d.ts:208



### toJSON[](#toJSON)

  * toJSON(): { goto: string | { args: any; node: string; } | (string | { args: any; node: string; })[]; resume: undefined | [R](langgraph.Command.html#constructor.new_Command.R-1); update: undefined | Record<string, unknown> | [string, unknown][]; }[](#toJSON.toJSON-1)
  * #### Returns { goto: string | { args: any; node: string; } | (string | { args: any; node: string; })[]; resume: undefined | [R](langgraph.Command.html#constructor.new_Command.R-1); update: undefined | Record<string, unknown> | [string, unknown][]; }

    * ##### goto: string | { args: any; node: string; } | (string | { args: any; node: string; })[]

    * ##### resume: undefined | [R](langgraph.Command.html#constructor.new_Command.R-1)

    * ##### update: undefined | Record<string, unknown> | [string, unknown][]

    * Defined in libs/langgraph/dist/constants.d.ts:209
...
[constructor](#constructor)[goto](#goto)[graph](#graph)[lc_direct_tool_output](#lc_direct_tool_output)[lg_name](#lg_name)[resume](#resume)[update](#update)[PARENT](#PARENT)[_updateAsTuples](#_updateAsTuples)[toJSON](#toJSON)
