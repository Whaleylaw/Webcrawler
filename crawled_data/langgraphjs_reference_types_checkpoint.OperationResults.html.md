---
url: https://langchain-ai.github.io/langgraphjs/reference/types/checkpoint.OperationResults.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [OperationResults](checkpoint.OperationResults.html)



# Type alias OperationResults<Tuple>

OperationResults<[Tuple](checkpoint.OperationResults.html#Tuple)>: {[K in keyof [Tuple](checkpoint.OperationResults.html#Tuple)]: [Tuple](checkpoint.OperationResults.html#Tuple)[K] extends [PutOperation](../interfaces/checkpoint.PutOperation.html)? void: [Tuple](checkpoint.OperationResults.html#Tuple)[K] extends [SearchOperation](../interfaces/checkpoint.SearchOperation.html)? [SearchItem](../interfaces/checkpoint.SearchItem.html)[]: [Tuple](checkpoint.OperationResults.html#Tuple)[K] extends [GetOperation](../interfaces/checkpoint.GetOperation.html)? [Item](../interfaces/checkpoint.Item.html) | null: [Tuple](checkpoint.OperationResults.html#Tuple)[K] extends [ListNamespacesOperation](../interfaces/checkpoint.ListNamespacesOperation.html)? string[][]: never}

#### Type Parameters

  * Tuple extends readonly [Operation](checkpoint.Operation.html)[]



  * Defined in libs/checkpoint/dist/store/base.d.ts:215
