---
url: https://langchain-ai.github.io/langgraphjs/reference/types/langgraph.TaskOptions.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [TaskOptions](langgraph.TaskOptions.html)



# Type alias TaskOptions`Beta`

TaskOptions: { name: string; retry?: [RetryPolicy](langgraph.RetryPolicy.html); }

Options for the [task](../functions/langgraph.task.html) function
...
The name of the task, analogous to the node name in [StateGraph](../classes/langgraph.StateGraph.html).

  * ##### `Optional` `Beta` retry?: [RetryPolicy](langgraph.RetryPolicy.html)
...
The retry policy for the task. Configures how many times and under what conditions the task should be retried if it fails.
  ...
  * Defined in libs/langgraph/dist/func/index.d.ts:17
