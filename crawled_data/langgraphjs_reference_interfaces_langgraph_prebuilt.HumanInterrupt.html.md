---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/langgraph_prebuilt.HumanInterrupt.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [HumanInterrupt](langgraph_prebuilt.HumanInterrupt.html)
...
interface HumanInterrupt { [action_request](langgraph_prebuilt.HumanInterrupt.html#action_request): [ActionRequest](langgraph_prebuilt.ActionRequest.html); [config](langgraph_prebuilt.HumanInterrupt.html#config): [HumanInterruptConfig](langgraph_prebuilt.HumanInterruptConfig.html); [description](langgraph_prebuilt.HumanInterrupt.html#description)?: string; }

  * Defined in libs/langgraph/dist/prebuilt/interrupt.d.ts:35
...
[action_request](langgraph_prebuilt.HumanInterrupt.html#action_request) [config](langgraph_prebuilt.HumanInterrupt.html#config) [description?](langgraph_prebuilt.HumanInterrupt.html#description)

## Properties

### action_request[](#action_request)

action_request: [ActionRequest](langgraph_prebuilt.ActionRequest.html)

The specific action being requested from the human

  * Defined in libs/langgraph/dist/prebuilt/interrupt.d.ts:36



### config[](#config)

config: [HumanInterruptConfig](langgraph_prebuilt.HumanInterruptConfig.html)

Configuration defining what actions are allowed

  * Defined in libs/langgraph/dist/prebuilt/interrupt.d.ts:37
...
Optional detailed description of what input is needed
  ...
  * Defined in libs/langgraph/dist/prebuilt/interrupt.d.ts:38
...
[action_request](#action_request)[config](#config)[description](#description)
