---
url: https://langchain-ai.github.io/langgraphjs/reference/functions/langgraph.getPreviousState.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [getPreviousState](langgraph.getPreviousState.html)



# Function getPreviousState

  * getPreviousState<[StateT](langgraph.getPreviousState.html#getPreviousState.StateT)>(): [StateT](langgraph.getPreviousState.html#getPreviousState.StateT)[](#getPreviousState)
  * `Beta`
...
This function allows workflows to access state that was saved in previous runs using [entrypoint.final](langgraph.entrypoint.html#final).
...
#### Returns [StateT](langgraph.getPreviousState.html#getPreviousState.StateT)
...
```
constpreviousState = getPreviousState<{ counter: number }>();constnewCount = (previousState?.counter ?? 0) + 1;
Copy
```


    * Defined in libs/langgraph/dist/func/index.d.ts:310
