---
url: https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/
title: Untitled
date_crawled: 
---
...
[ ](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/?q= "Share")
...
How-to Guides 
        ...
        * LangGraph Platform  LangGraph Platform 
          ...
          * Streaming  Streaming 
            ...
            * How to configure multiple streaming modes at the same time  [ How to configure multiple streaming modes at the same time  ](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/) Table of contents 
              * [ Setup  ](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#setup)
              * [ Stream graph with multiple modes  ](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#stream-graph-with-multiple-modes)
...
[ ](https://github.com/langchain-ai/langgraph/edit/main/docs/docs/cloud/how-tos/stream_multiple.md "Edit this page")
...
```
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-0-1)fromlanggraph_sdkimport get_client
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-0-2)
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-0-3)client = get_client(url=<DEPLOYMENT_URL>)
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-0-4)# Using the graph deployed with the name "agent"
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-0-5)assistant_id = "agent"
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-0-6)# create thread
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-0-7)thread = await client.threads.create()
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-0-8)print(thread)

```


```
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-1-1)import{Client}from"@langchain/langgraph-sdk";
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-1-2)
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-1-3)constclient=newClient({apiUrl:<DEPLOYMENT_URL>});
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-1-4)// Using the graph deployed with the name "agent"
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-1-5)constassistantID="agent";
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-1-6)// create thread
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-1-7)constthread=awaitclient.threads.create();
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-1-8)console.log(thread);

```


```
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-2-1)curl--requestPOST\
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-2-2)--url<DEPLOYMENT_URL>/threads\
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-2-3)--header'Content-Type: application/json'\
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-2-4)--data'{}'
...
```
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-1)# create input
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-2)input = {
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-3)  "messages": [
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-4)    {
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-5)      "role": "user",
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-6)      "content": "What's the weather in SF?",
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-7)    }
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-8)  ]
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-9)}
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-10)
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-11)# stream events with multiple streaming modes
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-12)async for chunk in client.runs.stream(
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-13)  thread_id=thread["thread_id"],
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-14)  assistant_id=assistant_id,
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-15)  input=input,
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-16)  stream_mode=["messages", "events", "debug"],
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-17)):
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-18)  print(f"Receiving new event of type: {chunk.event}...")
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-19)  print(chunk.data)
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-3-20)  print("\n\n")

```


```
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-1)// create input
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-2)constinput={
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-3)messages:[
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-4){
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-5)role:"human",
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-6)content:"What's the weather in SF?",
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-7)}
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-8)]
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-9)};
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-10)
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-11)// stream events with multiple streaming modes
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-12)conststreamResponse=client.runs.stream(
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-13)thread["thread_id"],
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-14)assistantID,
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-15){
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-16)input,
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-17)streamMode:["messages","events","debug"]
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-18)}
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-19));
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-20)forawait(constchunkofstreamResponse){
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-21)console.log(`Receiving new event of type: ${chunk.event}...`);
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-22)console.log(chunk.data);
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-23)console.log("\n\n");
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-4-24)}

```


```
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-1)curl--requestPOST\
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-2)--url<DEPLOYMENT_URL>/threads/<THREAD_ID>/runs/stream\
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-3)--header'Content-Type: application/json'\
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-4)--data"{
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-5)  \"assistant_id\": \"agent\",
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-6)  \"input\": {\"messages\": [{\"role\": \"human\", \"content\": \"What's the weather in SF?\"}]},
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-7)  \"stream_mode\": [
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-8)   \"messages\",
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-9)   \"events\",
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-10)   \"debug\"
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-11)  ]
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-12) }"|\
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-13)sed's/\r$//'|\
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-14)awk'
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-15) /^event:/ {
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-16)   if (data_content != "") {
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-17)     print data_content "\n"
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-18)   }
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-19)   sub(/^event: /, "Receiving event of type: ", $0)
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-20)   printf "%s...\n", $0
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-21)   data_content = ""
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-22) }
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-23) /^data:/ {
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-24)   sub(/^data: /, "", $0)
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-25)   data_content = $0
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-26) }
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-27) END {
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-28)   if (data_content != "") {
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-29)     print data_content "\n"
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-30)   }
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-31) }
[](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__codelineno-5-32) '
...
Back to top  [ Previous  How to stream debug events  ](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_debug/) [ Next  How to integrate LangGraph into your React application  ](https://langchain-ai.github.io/langgraph/cloud/how-tos/use_stream_react/)

Copyright © 2025 LangChain, Inc | [Consent Preferences](https://langchain-ai.github.io/langgraph/cloud/how-tos/stream_multiple/#__consent)
