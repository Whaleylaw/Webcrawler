---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.SharedValue.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [SharedValue](langgraph.SharedValue.html)



# Class SharedValue

#### Hierarchy ([view full](../hierarchy.html#langgraph.SharedValue))

  * [WritableManagedValue](langgraph.WritableManagedValue.html)<Value, Update>
    * SharedValue



  * Defined in libs/langgraph/dist/managed/shared_value.d.ts:11
...
[constructor](langgraph.SharedValue.html#constructor)

### Properties

[config](langgraph.SharedValue.html#config) [lg_is_managed_value](langgraph.SharedValue.html#lg_is_managed_value) [loadStore](langgraph.SharedValue.html#loadStore) [ns](langgraph.SharedValue.html#ns) [processUpdate](langgraph.SharedValue.html#processUpdate) [runtime](langgraph.SharedValue.html#runtime) [scope](langgraph.SharedValue.html#scope) [store](langgraph.SharedValue.html#store) [value](langgraph.SharedValue.html#value)

### Methods

[addPromise](langgraph.SharedValue.html#addPromise) [call](langgraph.SharedValue.html#call) [promises](langgraph.SharedValue.html#promises) [update](langgraph.SharedValue.html#update) [initialize](langgraph.SharedValue.html#initialize) [on](langgraph.SharedValue.html#on)

## Constructors

### constructor[](#constructor)

  * new SharedValue(config, params): [SharedValue](langgraph.SharedValue.html)[](#constructor.new_SharedValue)
  * #### Parameters

    * config: [LangGraphRunnableConfig](../interfaces/langgraph.LangGraphRunnableConfig.html)<Record<string, any>>
    * params: [SharedValueParams](../interfaces/langgraph.SharedValueParams.html)

#### Returns [SharedValue](langgraph.SharedValue.html)

Overrides [WritableManagedValue](langgraph.WritableManagedValue.html).[constructor](langgraph.WritableManagedValue.html#constructor)

    * Defined in libs/langgraph/dist/managed/shared_value.d.ts:16
...
Inherited from [WritableManagedValue](langgraph.WritableManagedValue.html).[config](langgraph.WritableManagedValue.html#config)

  * Defined in libs/langgraph/dist/managed/base.d.ts:6



### lg_is_managed_value[](#lg_is_managed_value)

lg_is_managed_value: boolean

Inherited from [WritableManagedValue](langgraph.WritableManagedValue.html).[lg_is_managed_value](langgraph.WritableManagedValue.html#lg_is_managed_value)

  * Defined in libs/langgraph/dist/managed/base.d.ts:8
...
loadStore: any
  ...
  * Defined in libs/langgraph/dist/managed/shared_value.d.ts:22



### ns[](#ns)

ns: null | ["scoped", string, string, any]

  * Defined in libs/langgraph/dist/managed/shared_value.d.ts:14
...
processUpdate: any
  ...
  * Defined in libs/langgraph/dist/managed/shared_value.d.ts:20
...
Inherited from [WritableManagedValue](langgraph.WritableManagedValue.html).[runtime](langgraph.WritableManagedValue.html#runtime)

  * Defined in libs/langgraph/dist/managed/base.d.ts:5
...
scope: string
  ...
  * Defined in libs/langgraph/dist/managed/shared_value.d.ts:12



### store[](#store)

store: null | [BaseStore](checkpoint.BaseStore.html)

  * Defined in libs/langgraph/dist/managed/shared_value.d.ts:13
...
value: Value
  ...
  * Defined in libs/langgraph/dist/managed/shared_value.d.ts:15



## Methods

### `Protected` addPromise[](#addPromise)

  * addPromise(promise): void[](#addPromise.addPromise-1)
  * #### Parameters
...
Inherited from [WritableManagedValue](langgraph.WritableManagedValue.html).[addPromise](langgraph.WritableManagedValue.html#addPromise)

    * Defined in libs/langgraph/dist/managed/base.d.ts:13



### call[](#call)

  * call(_step): Value[](#call.call-1)
  * #### Parameters
...
Overrides [WritableManagedValue](langgraph.WritableManagedValue.html).[call](langgraph.WritableManagedValue.html#call)

    * Defined in libs/langgraph/dist/managed/shared_value.d.ts:19



### promises[](#promises)

  * promises(): Promise<unknown>[](#promises.promises-1)
  * #### Returns Promise<unknown>

Inherited from [WritableManagedValue](langgraph.WritableManagedValue.html).[promises](langgraph.WritableManagedValue.html#promises)

    * Defined in libs/langgraph/dist/managed/base.d.ts:12



### update[](#update)

  * update(values): Promise<void>[](#update.update-1)
  * #### Parameters
...
Overrides [WritableManagedValue](langgraph.WritableManagedValue.html).[update](langgraph.WritableManagedValue.html#update-2)

    * Defined in libs/langgraph/dist/managed/shared_value.d.ts:21



### `Static` initialize[](#initialize)

  * initialize<[Value](langgraph.SharedValue.html#initialize.initialize-1.Value-1)>(config, args): Promise<[ManagedValue](langgraph.ManagedValue.html)<[Value](langgraph.SharedValue.html#initialize.initialize-1.Value-1)>>[](#initialize.initialize-1)
  * #### Type Parameters
...
#### Parameters
    ...
    * config: RunnableConfig<Record<string, any>>
    * args: [SharedValueParams](../interfaces/langgraph.SharedValueParams.html)

#### Returns Promise<[ManagedValue](langgraph.ManagedValue.html)<[Value](langgraph.SharedValue.html#initialize.initialize-1.Value-1)>>

Overrides [WritableManagedValue](langgraph.WritableManagedValue.html).[initialize](langgraph.WritableManagedValue.html#initialize)

    * Defined in libs/langgraph/dist/managed/shared_value.d.ts:17



### `Static` on[](#on)

  * on(scope): [ConfiguredManagedValue](../interfaces/langgraph.ConfiguredManagedValue.html)<Value>[](#on.on-1)
  * #### Parameters

    * scope: string

#### Returns [ConfiguredManagedValue](../interfaces/langgraph.ConfiguredManagedValue.html)<Value>

    * Defined in libs/langgraph/dist/managed/shared_value.d.ts:18
...
[constructor](#constructor)[config](#config)[lg_is_managed_value](#lg_is_managed_value)[loadStore](#loadStore)[ns](#ns)[processUpdate](#processUpdate)[runtime](#runtime)[scope](#scope)[store](#store)[value](#value)[addPromise](#addPromise)[call](#call)[promises](#promises)[update](#update)[initialize](#initialize)[on](#on)
