---
url: https://langchain-ai.github.io/langgraphjs/reference/functions/langgraph_prebuilt.toolsCondition.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [toolsCondition](langgraph_prebuilt.toolsCondition.html)



# Function toolsCondition

  * toolsCondition(state): "tools" | typeof [END](../variables/langgraph.END.html)[](#toolsCondition)
  * #### Parameters

    * state: BaseMessage[] | [StateType](../types/langgraph.StateType.html)<{ messages: [BinaryOperatorAggregate](../classes/langgraph.BinaryOperatorAggregate.html)<BaseMessage[], [Messages](../types/langgraph.Messages.html)>; }>

#### Returns "tools" | typeof [END](../variables/langgraph.END.html)

    * Defined in libs/langgraph/dist/prebuilt/tool_node.d.ts:136
