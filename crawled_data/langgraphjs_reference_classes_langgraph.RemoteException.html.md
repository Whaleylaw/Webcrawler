---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.RemoteException.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [RemoteException](langgraph.RemoteException.html)
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.RemoteException))
  ...
  * Defined in libs/langgraph/dist/errors.d.ts:61
...
[constructor](langgraph.RemoteException.html#constructor)

### Properties

[lc_error_code?](langgraph.RemoteException.html#lc_error_code) [message](langgraph.RemoteException.html#message) [name](langgraph.RemoteException.html#name) [stack?](langgraph.RemoteException.html#stack) [prepareStackTrace?](langgraph.RemoteException.html#prepareStackTrace) [stackTraceLimit](langgraph.RemoteException.html#stackTraceLimit)

### Accessors

[unminifiable_name](langgraph.RemoteException.html#unminifiable_name)

### Methods

[captureStackTrace](langgraph.RemoteException.html#captureStackTrace)

## Constructors

### constructor[](#constructor)

  * new RemoteException(message?, fields?): [RemoteException](langgraph.RemoteException.html)[](#constructor.new_RemoteException)
  * #### Parameters

    * `Optional` message: string
    * `Optional` fields: [BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html)

#### Returns [RemoteException](langgraph.RemoteException.html)

Overrides [BaseLangGraphError](langgraph.BaseLangGraphError.html).[constructor](langgraph.BaseLangGraphError.html#constructor)

    * Defined in libs/langgraph/dist/errors.d.ts:62
...
### `Static` unminifiable_name[](#unminifiable_name)
  ...
  * #### Returns string
    ...
    * Defined in libs/langgraph/dist/errors.d.ts:63
