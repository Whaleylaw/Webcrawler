---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/checkpoint.Item.html
title: Untitled
date_crawled: 
---
...
interface Item { [createdAt](checkpoint.Item.html#createdAt): Date; [key](checkpoint.Item.html#key): string; [namespace](checkpoint.Item.html#namespace): string[]; [updatedAt](checkpoint.Item.html#updatedAt): Date; [value](checkpoint.Item.html#value): Record<string, any>; }

#### Hierarchy ([view full](../hierarchy.html#checkpoint.Item))
  ...
  * Defined in libs/checkpoint/dist/store/base.d.ts:11
...
[createdAt](checkpoint.Item.html#createdAt) [key](checkpoint.Item.html#key) [namespace](checkpoint.Item.html#namespace) [updatedAt](checkpoint.Item.html#updatedAt) [value](checkpoint.Item.html#value)
...
[createdAt](#createdAt)[key](#key)[namespace](#namespace)[updatedAt](#updatedAt)[value](#value)
