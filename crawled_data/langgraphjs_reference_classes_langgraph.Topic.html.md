---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.Topic.html
title: Untitled
date_crawled: 
---
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.Topic))

  * [BaseChannel](langgraph.BaseChannel.html)<[Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[], [Value](langgraph.Topic.html#constructor.new_Topic.Value-1) | [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[], [[Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[], [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[]]>
    * Topic



  * Defined in libs/langgraph/dist/channels/topic.d.ts:5
...
[constructor](langgraph.Topic.html#constructor)

### Properties

[UpdateType](langgraph.Topic.html#UpdateType) [ValueType](langgraph.Topic.html#ValueType) [accumulate](langgraph.Topic.html#accumulate) [lc_graph_name](langgraph.Topic.html#lc_graph_name) [seen](langgraph.Topic.html#seen) [unique](langgraph.Topic.html#unique) [values](langgraph.Topic.html#values)

### Methods

[checkpoint](langgraph.Topic.html#checkpoint) [consume](langgraph.Topic.html#consume) [fromCheckpoint](langgraph.Topic.html#fromCheckpoint) [get](langgraph.Topic.html#get) [update](langgraph.Topic.html#update)

## Constructors

### constructor[](#constructor)

  * new Topic<[Value](langgraph.Topic.html#constructor.new_Topic.Value-1)>(fields?): [Topic](langgraph.Topic.html)<[Value](langgraph.Topic.html#constructor.new_Topic.Value-1)>[](#constructor.new_Topic)
  * #### Type Parameters
...
#### Parameters
    ...
    * `Optional` fields: { accumulate?: boolean; unique?: boolean; }
      * ##### `Optional` accumulate?: boolean

      * ##### `Optional` unique?: boolean

#### Returns [Topic](langgraph.Topic.html)<[Value](langgraph.Topic.html#constructor.new_Topic.Value-1)>

Overrides [BaseChannel](langgraph.BaseChannel.html).[constructor](langgraph.BaseChannel.html#constructor)

    * Defined in libs/langgraph/dist/channels/topic.d.ts:14
...
UpdateType: [Value](langgraph.Topic.html#constructor.new_Topic.Value-1) | [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[]
...
ValueType: [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[]
...
accumulate: boolean
  ...
  * Defined in libs/langgraph/dist/channels/topic.d.ts:11
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[lc_graph_name](langgraph.BaseChannel.html#lc_graph_name)
  ...
  * Defined in libs/langgraph/dist/channels/topic.d.ts:9



### seen[](#seen)

seen: Set<[Value](langgraph.Topic.html#constructor.new_Topic.Value-1)>

  * Defined in libs/langgraph/dist/channels/topic.d.ts:12
...
unique: boolean
  ...
  * Defined in libs/langgraph/dist/channels/topic.d.ts:10



### values[](#values)

values: [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[]

  * Defined in libs/langgraph/dist/channels/topic.d.ts:13
...
### checkpoint[](#checkpoint)
  ...
  * checkpoint(): [[Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[], [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[]][](#checkpoint.checkpoint-1)
  * Return a string representation of the channel's current state.

#### Returns [[Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[], [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[]]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[checkpoint](langgraph.BaseChannel.html#checkpoint)
    ...
    * Defined in libs/langgraph/dist/channels/topic.d.ts:21
...
#### Parameters
    ...
    * `Optional` checkpoint: [[Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[], [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[]]

#### Returns this

Overrides [BaseChannel](langgraph.BaseChannel.html).[fromCheckpoint](langgraph.BaseChannel.html#fromCheckpoint)

    * Defined in libs/langgraph/dist/channels/topic.d.ts:18



### get[](#get)

  * get(): [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[][](#get.get-1)
  * Return the current value of the channel.

#### Returns [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[get](langgraph.BaseChannel.html#get)
    ...
    * Defined in libs/langgraph/dist/channels/topic.d.ts:20
...
#### Parameters
    ...
    * values: ([Value](langgraph.Topic.html#constructor.new_Topic.Value-1) | [Value](langgraph.Topic.html#constructor.new_Topic.Value-1)[])[]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[update](langgraph.BaseChannel.html#update)
    ...
    * Defined in libs/langgraph/dist/channels/topic.d.ts:19
...
[constructor](#constructor)[UpdateType](#UpdateType)[ValueType](#ValueType)[accumulate](#accumulate)[lc_graph_name](#lc_graph_name)[seen](#seen)[unique](#unique)[values](#values)[checkpoint](#checkpoint)[consume](#consume)[fromCheckpoint](#fromCheckpoint)[get](#get)[update](#update)
