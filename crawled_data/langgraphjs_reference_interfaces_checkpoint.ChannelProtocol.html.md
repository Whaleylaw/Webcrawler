---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/checkpoint.ChannelProtocol.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [ChannelProtocol](checkpoint.ChannelProtocol.html)



# Interface ChannelProtocol<ValueType, UpdateType, CheckpointType>

interface ChannelProtocol<[ValueType](checkpoint.ChannelProtocol.html#ValueType), [UpdateType](checkpoint.ChannelProtocol.html#UpdateType), [CheckpointType](checkpoint.ChannelProtocol.html#CheckpointType)> { [UpdateType](checkpoint.ChannelProtocol.html#UpdateType-1): [UpdateType](checkpoint.ChannelProtocol.html#UpdateType); [ValueType](checkpoint.ChannelProtocol.html#ValueType-1): [ValueType](checkpoint.ChannelProtocol.html#ValueType); [lc_graph_name](checkpoint.ChannelProtocol.html#lc_graph_name): string; [checkpoint](checkpoint.ChannelProtocol.html#checkpoint.checkpoint-1)(): undefined | [CheckpointType](checkpoint.ChannelProtocol.html#CheckpointType); [fromCheckpoint](checkpoint.ChannelProtocol.html#fromCheckpoint.fromCheckpoint-1)(checkpoint?): this; [get](checkpoint.ChannelProtocol.html#get.get-1)(): [ValueType](checkpoint.ChannelProtocol.html#ValueType); [update](checkpoint.ChannelProtocol.html#update.update-1)(values): void; }
...
#### Type Parameters
  ...
  * Defined in libs/checkpoint/dist/serde/types.d.ts:6
...
[UpdateType](checkpoint.ChannelProtocol.html#UpdateType-1) [ValueType](checkpoint.ChannelProtocol.html#ValueType-1) [lc_graph_name](checkpoint.ChannelProtocol.html#lc_graph_name)

### Methods

[checkpoint](checkpoint.ChannelProtocol.html#checkpoint) [fromCheckpoint](checkpoint.ChannelProtocol.html#fromCheckpoint) [get](checkpoint.ChannelProtocol.html#get) [update](checkpoint.ChannelProtocol.html#update)

## Properties

### UpdateType[](#UpdateType-1)

UpdateType: [UpdateType](checkpoint.ChannelProtocol.html#UpdateType)

  * Defined in libs/checkpoint/dist/serde/types.d.ts:6
  * Defined in libs/checkpoint/dist/serde/types.d.ts:8



### ValueType[](#ValueType-1)

ValueType: [ValueType](checkpoint.ChannelProtocol.html#ValueType)

  * Defined in libs/checkpoint/dist/serde/types.d.ts:6
  * Defined in libs/checkpoint/dist/serde/types.d.ts:7
...
The name of the channel.
  ...
  * Defined in libs/checkpoint/dist/serde/types.d.ts:12
...
### checkpoint[](#checkpoint)
  ...
  * checkpoint(): undefined | [CheckpointType](checkpoint.ChannelProtocol.html#CheckpointType)[](#checkpoint.checkpoint-1)
  * Return a string representation of the channel's current state.

#### Returns undefined | [CheckpointType](checkpoint.ChannelProtocol.html#CheckpointType)

#### Throws

if the channel is empty (never updated yet), or doesn't support checkpoints.

    * Defined in libs/checkpoint/dist/serde/types.d.ts:44
...
#### Parameters
    ...
    * `Optional` checkpoint: [CheckpointType](checkpoint.ChannelProtocol.html#CheckpointType)

#### Returns this

    * Defined in libs/checkpoint/dist/serde/types.d.ts:21



### get[](#get)

  * get(): [ValueType](checkpoint.ChannelProtocol.html#ValueType)[](#get.get-1)
  * Return the current value of the channel.

#### Returns [ValueType](checkpoint.ChannelProtocol.html#ValueType)

#### Throws

if the channel is empty (never updated yet).

    * Defined in libs/checkpoint/dist/serde/types.d.ts:37



### update[](#update)

  * update(values): void[](#update.update-1)
  * Update the channel's value with the given sequence of updates. The order of the updates in the sequence is arbitrary.

#### Parameters

    * values: [UpdateType](checkpoint.ChannelProtocol.html#UpdateType)[]
...
if the sequence of updates is invalid.
    ...
    * Defined in libs/checkpoint/dist/serde/types.d.ts:30
...
[UpdateType](#UpdateType-1)[ValueType](#ValueType-1)[lc_graph_name](#lc_graph_name)[checkpoint](#checkpoint)[fromCheckpoint](#fromCheckpoint)[get](#get)[update](#update)
