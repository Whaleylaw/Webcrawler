---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.DynamicBarrierValue.html
title: Untitled
date_crawled: 
---
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.DynamicBarrierValue))

  * [BaseChannel](langgraph.BaseChannel.html)<void, [Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1) | [WaitForNames](../interfaces/langgraph.WaitForNames.html)<[Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)>, [[Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)[] | undefined, [Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)[]]>
    * DynamicBarrierValue



  * Defined in libs/langgraph/dist/channels/dynamic_barrier_value.d.ts:15
...
[constructor](langgraph.DynamicBarrierValue.html#constructor)

### Properties

[UpdateType](langgraph.DynamicBarrierValue.html#UpdateType) [ValueType](langgraph.DynamicBarrierValue.html#ValueType) [lc_graph_name](langgraph.DynamicBarrierValue.html#lc_graph_name) [names?](langgraph.DynamicBarrierValue.html#names) [seen](langgraph.DynamicBarrierValue.html#seen)

### Methods

[checkpoint](langgraph.DynamicBarrierValue.html#checkpoint) [consume](langgraph.DynamicBarrierValue.html#consume) [fromCheckpoint](langgraph.DynamicBarrierValue.html#fromCheckpoint) [get](langgraph.DynamicBarrierValue.html#get) [update](langgraph.DynamicBarrierValue.html#update)

## Constructors

### constructor[](#constructor)

  * new DynamicBarrierValue<[Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)>(): [DynamicBarrierValue](langgraph.DynamicBarrierValue.html)<[Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)>[](#constructor.new_DynamicBarrierValue)
  * #### Type Parameters

    * Value

#### Returns [DynamicBarrierValue](langgraph.DynamicBarrierValue.html)<[Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)>

Overrides [BaseChannel](langgraph.BaseChannel.html).[constructor](langgraph.BaseChannel.html#constructor)

    * Defined in libs/langgraph/dist/channels/dynamic_barrier_value.d.ts:22
...
UpdateType: [Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1) | [WaitForNames](../interfaces/langgraph.WaitForNames.html)<[Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)>
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[lc_graph_name](langgraph.BaseChannel.html#lc_graph_name)
  ...
  * Defined in libs/langgraph/dist/channels/dynamic_barrier_value.d.ts:19



### `Optional` names[](#names)

names?: Set<[Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)>

  * Defined in libs/langgraph/dist/channels/dynamic_barrier_value.d.ts:20



### seen[](#seen)

seen: Set<[Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)>

  * Defined in libs/langgraph/dist/channels/dynamic_barrier_value.d.ts:21
...
### checkpoint[](#checkpoint)
  ...
  * checkpoint(): [undefined | [Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)[], [Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)[]][](#checkpoint.checkpoint-1)
  * Return a string representation of the channel's current state.

#### Returns [undefined | [Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)[], [Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)[]]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[checkpoint](langgraph.BaseChannel.html#checkpoint)
    ...
    * Defined in libs/langgraph/dist/channels/dynamic_barrier_value.d.ts:27
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[consume](langgraph.BaseChannel.html#consume)

    * Defined in libs/langgraph/dist/channels/dynamic_barrier_value.d.ts:25
...
#### Parameters
    ...
    * `Optional` checkpoint: [undefined | [Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)[], [Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)[]]

#### Returns this

Overrides [BaseChannel](langgraph.BaseChannel.html).[fromCheckpoint](langgraph.BaseChannel.html#fromCheckpoint)

    * Defined in libs/langgraph/dist/channels/dynamic_barrier_value.d.ts:23
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[get](langgraph.BaseChannel.html#get)
    ...
    * Defined in libs/langgraph/dist/channels/dynamic_barrier_value.d.ts:26
...
#### Parameters
    ...
    * values: ([Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1) | [WaitForNames](../interfaces/langgraph.WaitForNames.html)<[Value](langgraph.DynamicBarrierValue.html#constructor.new_DynamicBarrierValue.Value-1)>)[]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[update](langgraph.BaseChannel.html#update)
    ...
    * Defined in libs/langgraph/dist/channels/dynamic_barrier_value.d.ts:24
...
[constructor](#constructor)[UpdateType](#UpdateType)[ValueType](#ValueType)[lc_graph_name](#lc_graph_name)[names](#names)[seen](#seen)[checkpoint](#checkpoint)[consume](#consume)[fromCheckpoint](#fromCheckpoint)[get](#get)[update](#update)
