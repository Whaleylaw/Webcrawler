---
url: https://langchain-ai.github.io/langgraphjs/reference/types/langgraph.NodeType.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [NodeType](langgraph.NodeType.html)



# Type alias NodeType<SD>

NodeType<[SD](langgraph.NodeType.html#SD)>: RunnableLike<[StateType](langgraph.StateType.html)<[SD](langgraph.NodeType.html#SD)>, [UpdateType](langgraph.UpdateType.html)<[SD](langgraph.NodeType.html#SD)> | Partial<[StateType](langgraph.StateType.html)<[SD](langgraph.NodeType.html#SD)>>>
...
#### Type Parameters
  ...
  * Defined in libs/langgraph/dist/graph/annotation.d.ts:27
