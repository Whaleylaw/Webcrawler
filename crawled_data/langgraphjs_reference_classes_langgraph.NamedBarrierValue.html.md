---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.NamedBarrierValue.html
title: Untitled
date_crawled: 
---
...
# Class NamedBarrierValue<Value>`Internal`
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.NamedBarrierValue))

  * [BaseChannel](langgraph.BaseChannel.html)<void, [Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1), [Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)[]>
    * NamedBarrierValue



  * Defined in libs/langgraph/dist/channels/named_barrier_value.d.ts:10
...
[constructor](langgraph.NamedBarrierValue.html#constructor)

### Properties

[UpdateType](langgraph.NamedBarrierValue.html#UpdateType) [ValueType](langgraph.NamedBarrierValue.html#ValueType) [lc_graph_name](langgraph.NamedBarrierValue.html#lc_graph_name) [names](langgraph.NamedBarrierValue.html#names) [seen](langgraph.NamedBarrierValue.html#seen)

### Methods

[checkpoint](langgraph.NamedBarrierValue.html#checkpoint) [consume](langgraph.NamedBarrierValue.html#consume) [fromCheckpoint](langgraph.NamedBarrierValue.html#fromCheckpoint) [get](langgraph.NamedBarrierValue.html#get) [update](langgraph.NamedBarrierValue.html#update)

## Constructors

### constructor[](#constructor)

  * new NamedBarrierValue<[Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)>(names): [NamedBarrierValue](langgraph.NamedBarrierValue.html)<[Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)>[](#constructor.new_NamedBarrierValue)
  * #### Type Parameters
...
#### Parameters
    ...
    * names: Set<[Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)>

#### Returns [NamedBarrierValue](langgraph.NamedBarrierValue.html)<[Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)>

Overrides [BaseChannel](langgraph.BaseChannel.html).[constructor](langgraph.BaseChannel.html#constructor)

    * Defined in libs/langgraph/dist/channels/named_barrier_value.d.ts:14
...
UpdateType: [Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[lc_graph_name](langgraph.BaseChannel.html#lc_graph_name)
  ...
  * Defined in libs/langgraph/dist/channels/named_barrier_value.d.ts:11
...
names: Set<[Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)>
  ...
  * Defined in libs/langgraph/dist/channels/named_barrier_value.d.ts:12



### seen[](#seen)

seen: Set<[Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)>

  * Defined in libs/langgraph/dist/channels/named_barrier_value.d.ts:13
...
### checkpoint[](#checkpoint)
  ...
  * checkpoint(): [Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)[][](#checkpoint.checkpoint-1)
  * Return a string representation of the channel's current state.

#### Returns [Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)[]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[checkpoint](langgraph.BaseChannel.html#checkpoint)
    ...
    * Defined in libs/langgraph/dist/channels/named_barrier_value.d.ts:18
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[consume](langgraph.BaseChannel.html#consume)
    ...
    * Defined in libs/langgraph/dist/channels/named_barrier_value.d.ts:19
...
#### Parameters
    ...
    * `Optional` checkpoint: [Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)[]

#### Returns this

Overrides [BaseChannel](langgraph.BaseChannel.html).[fromCheckpoint](langgraph.BaseChannel.html#fromCheckpoint)

    * Defined in libs/langgraph/dist/channels/named_barrier_value.d.ts:15
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[get](langgraph.BaseChannel.html#get)
    ...
    * Defined in libs/langgraph/dist/channels/named_barrier_value.d.ts:17
...
#### Parameters
    ...
    * values: [Value](langgraph.NamedBarrierValue.html#constructor.new_NamedBarrierValue.Value-1)[]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[update](langgraph.BaseChannel.html#update)
    ...
    * Defined in libs/langgraph/dist/channels/named_barrier_value.d.ts:16
