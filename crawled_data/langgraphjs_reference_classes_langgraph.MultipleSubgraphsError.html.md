---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.MultipleSubgraphsError.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [MultipleSubgraphsError](langgraph.MultipleSubgraphsError.html)



# Class MultipleSubgraphsError

#### Hierarchy ([view full](../hierarchy.html#langgraph.MultipleSubgraphsError))

  * [BaseLangGraphError](langgraph.BaseLangGraphError.html)
    * MultipleSubgraphsError



  * Defined in libs/langgraph/dist/errors.d.ts:50
...
[constructor](langgraph.MultipleSubgraphsError.html#constructor)

### Properties

[lc_error_code?](langgraph.MultipleSubgraphsError.html#lc_error_code) [message](langgraph.MultipleSubgraphsError.html#message) [name](langgraph.MultipleSubgraphsError.html#name) [stack?](langgraph.MultipleSubgraphsError.html#stack) [prepareStackTrace?](langgraph.MultipleSubgraphsError.html#prepareStackTrace) [stackTraceLimit](langgraph.MultipleSubgraphsError.html#stackTraceLimit)

### Accessors

[unminifiable_name](langgraph.MultipleSubgraphsError.html#unminifiable_name)

### Methods

[captureStackTrace](langgraph.MultipleSubgraphsError.html#captureStackTrace)

## Constructors

### constructor[](#constructor)

  * new MultipleSubgraphsError(message?, fields?): [MultipleSubgraphsError](langgraph.MultipleSubgraphsError.html)[](#constructor.new_MultipleSubgraphsError)
  * #### Parameters

    * `Optional` message: string
    * `Optional` fields: [BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html)

#### Returns [MultipleSubgraphsError](langgraph.MultipleSubgraphsError.html)

Overrides [BaseLangGraphError](langgraph.BaseLangGraphError.html).[constructor](langgraph.BaseLangGraphError.html#constructor)

    * Defined in libs/langgraph/dist/errors.d.ts:51
...
Inherited from [BaseLangGraphError](langgraph.BaseLangGraphError.html).[lc_error_code](langgraph.BaseLangGraphError.html#lc_error_code)
...
Inherited from [BaseLangGraphError](langgraph.BaseLangGraphError.html).[message](langgraph.BaseLangGraphError.html#message)
...
Inherited from [BaseLangGraphError](langgraph.BaseLangGraphError.html).[name](langgraph.BaseLangGraphError.html#name)
...
Inherited from [BaseLangGraphError](langgraph.BaseLangGraphError.html).[stack](langgraph.BaseLangGraphError.html#stack)
...
Inherited from [BaseLangGraphError](langgraph.BaseLangGraphError.html).[prepareStackTrace](langgraph.BaseLangGraphError.html#prepareStackTrace)
...
Inherited from [BaseLangGraphError](langgraph.BaseLangGraphError.html).[stackTraceLimit](langgraph.BaseLangGraphError.html#stackTraceLimit)
...
### `Static` unminifiable_name[](#unminifiable_name)
  ...
  * #### Returns string
    ...
    * Defined in libs/langgraph/dist/errors.d.ts:52
...
Inherited from [BaseLangGraphError](langgraph.BaseLangGraphError.html).[captureStackTrace](langgraph.BaseLangGraphError.html#captureStackTrace)
...
[constructor](#constructor)[lc_error_code](#lc_error_code)[message](#message)[name](#name)[stack](#stack)[prepareStackTrace](#prepareStackTrace)[stackTraceLimit](#stackTraceLimit)[unminifiable_name](#unminifiable_name)[captureStackTrace](#captureStackTrace)
