---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/langgraph.ConfiguredManagedValue.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [ConfiguredManagedValue](langgraph.ConfiguredManagedValue.html)



# Interface ConfiguredManagedValue<Value>

interface ConfiguredManagedValue<[Value](langgraph.ConfiguredManagedValue.html#Value)> { [cls](langgraph.ConfiguredManagedValue.html#cls): { prototype: [ManagedValue](../classes/langgraph.ManagedValue.html)<any>; initialize<[Value](langgraph.ConfiguredManagedValue.html#cls.__type.initialize.initialize-1.Value-1)>(_config, _args?): Promise<[ManagedValue](../classes/langgraph.ManagedValue.html)<[Value](../classes/langgraph.ManagedValue.html#initialize.initialize-1.Value-2)>>; new (config, _params?): [ManagedValue](../classes/langgraph.ManagedValue.html)<[Value](langgraph.ConfiguredManagedValue.html#Value)>; }; [params](langgraph.ConfiguredManagedValue.html#params): [ManagedValueParams](langgraph.ManagedValueParams.html); }
...
#### Type Parameters
  ...
  * Defined in libs/langgraph/dist/managed/base.d.ts:20
...
[cls](langgraph.ConfiguredManagedValue.html#cls) [params](langgraph.ConfiguredManagedValue.html#params)

## Properties

### cls[](#cls)

cls: { prototype: [ManagedValue](../classes/langgraph.ManagedValue.html)<any>; initialize<[Value](langgraph.ConfiguredManagedValue.html#cls.__type.initialize.initialize-1.Value-1)>(_config, _args?): Promise<[ManagedValue](../classes/langgraph.ManagedValue.html)<[Value](../classes/langgraph.ManagedValue.html#initialize.initialize-1.Value-2)>>; new (config, _params?): [ManagedValue](../classes/langgraph.ManagedValue.html)<[Value](langgraph.ConfiguredManagedValue.html#Value)>; }

#### Type declaration

  *     * new (config, _params?): [ManagedValue](../classes/langgraph.ManagedValue.html)<[Value](langgraph.ConfiguredManagedValue.html#Value)>
    * #### Parameters

      * config: RunnableConfig<Record<string, any>>
      * `Optional` _params: [ManagedValueParams](langgraph.ManagedValueParams.html)

#### Returns [ManagedValue](../classes/langgraph.ManagedValue.html)<[Value](langgraph.ConfiguredManagedValue.html#Value)>

  * ##### prototype: [ManagedValue](../classes/langgraph.ManagedValue.html)<any>

  * ##### initialize:function

    * initialize<[Value](langgraph.ConfiguredManagedValue.html#cls.__type.initialize.initialize-1.Value-1)>(_config, _args?): Promise<[ManagedValue](../classes/langgraph.ManagedValue.html)<[Value](../classes/langgraph.ManagedValue.html#initialize.initialize-1.Value-2)>>[](#cls.__type.initialize.initialize-1)
    * #### Type Parameters
...
#### Returns Promise<[ManagedValue](../classes/langgraph.ManagedValue.html)<[Value](../classes/langgraph.ManagedValue.html#initialize.initialize-1.Value-2)>>

      * Defined in libs/langgraph/dist/managed/base.d.ts:10



  * Defined in libs/langgraph/dist/managed/base.d.ts:21



### params[](#params)

params: [ManagedValueParams](langgraph.ManagedValueParams.html)

  * Defined in libs/langgraph/dist/managed/base.d.ts:22
