---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.GraphValueError.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [GraphValueError](langgraph.GraphValueError.html)



# Class GraphValueError

#### Hierarchy ([view full](../hierarchy.html#langgraph.GraphValueError))
  ...
  * Defined in libs/langgraph/dist/errors.d.ts:16
...
[constructor](langgraph.GraphValueError.html#constructor)

### Properties

[lc_error_code?](langgraph.GraphValueError.html#lc_error_code) [message](langgraph.GraphValueError.html#message) [name](langgraph.GraphValueError.html#name) [stack?](langgraph.GraphValueError.html#stack) [prepareStackTrace?](langgraph.GraphValueError.html#prepareStackTrace) [stackTraceLimit](langgraph.GraphValueError.html#stackTraceLimit)

### Accessors

[unminifiable_name](langgraph.GraphValueError.html#unminifiable_name)

### Methods

[captureStackTrace](langgraph.GraphValueError.html#captureStackTrace)

## Constructors

### constructor[](#constructor)

  * new GraphValueError(message?, fields?): [GraphValueError](langgraph.GraphValueError.html)[](#constructor.new_GraphValueError)
  * #### Parameters

    * `Optional` message: string
    * `Optional` fields: [BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html)

#### Returns [GraphValueError](langgraph.GraphValueError.html)

Overrides [BaseLangGraphError](langgraph.BaseLangGraphError.html).[constructor](langgraph.BaseLangGraphError.html#constructor)

    * Defined in libs/langgraph/dist/errors.d.ts:17
...
### `Static` unminifiable_name[](#unminifiable_name)
  ...
  * #### Returns string
    ...
    * Defined in libs/langgraph/dist/errors.d.ts:18
