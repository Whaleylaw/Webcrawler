---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/langgraph.StateSnapshot.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [StateSnapshot](langgraph.StateSnapshot.html)



# Interface StateSnapshot

interface StateSnapshot { [config](langgraph.StateSnapshot.html#config): RunnableConfig<Record<string, any>>; [createdAt](langgraph.StateSnapshot.html#createdAt)?: string; [metadata](langgraph.StateSnapshot.html#metadata)?: [CheckpointMetadata](checkpoint.CheckpointMetadata.html); [next](langgraph.StateSnapshot.html#next): string[]; [parentConfig](langgraph.StateSnapshot.html#parentConfig)?: RunnableConfig<Record<string, any>>; [tasks](langgraph.StateSnapshot.html#tasks): PregelTaskDescription[]; [values](langgraph.StateSnapshot.html#values): any; }

  * Defined in libs/langgraph/dist/pregel/types.d.ts:162
...
[config](langgraph.StateSnapshot.html#config) [createdAt?](langgraph.StateSnapshot.html#createdAt) [metadata?](langgraph.StateSnapshot.html#metadata) [next](langgraph.StateSnapshot.html#next) [parentConfig?](langgraph.StateSnapshot.html#parentConfig) [tasks](langgraph.StateSnapshot.html#tasks) [values](langgraph.StateSnapshot.html#values)
...
Config used to fetch this snapshot
  ...
  * Defined in libs/langgraph/dist/pregel/types.d.ts:174



### `Optional` `Readonly` createdAt[](#createdAt)

createdAt?: string

Time when the snapshot was created

  * Defined in libs/langgraph/dist/pregel/types.d.ts:182



### `Optional` `Readonly` metadata[](#metadata)

metadata?: [CheckpointMetadata](checkpoint.CheckpointMetadata.html)

Metadata about the checkpoint

  * Defined in libs/langgraph/dist/pregel/types.d.ts:178
...
Nodes to execute in the next step, if any
  ...
  * Defined in libs/langgraph/dist/pregel/types.d.ts:170



### `Optional` `Readonly` parentConfig[](#parentConfig)
...
```
  ...
  * Defined in libs/langgraph/dist/pregel/types.d.ts:187
...
Tasks to execute in this step. If already attempted, may contain an error.
  ...
  * Defined in libs/langgraph/dist/pregel/types.d.ts:191
...
Current values of channels
  ...
  * Defined in libs/langgraph/dist/pregel/types.d.ts:166
...
[config](#config)[createdAt](#createdAt)[metadata](#metadata)[next](#next)[parentConfig](#parentConfig)[tasks](#tasks)[values](#values)
