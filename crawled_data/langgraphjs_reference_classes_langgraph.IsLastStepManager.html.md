---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.IsLastStepManager.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [IsLastStepManager](langgraph.IsLastStepManager.html)



# Class IsLastStepManager

#### Hierarchy ([view full](../hierarchy.html#langgraph.IsLastStepManager))

  * [ManagedValue](langgraph.ManagedValue.html)<boolean>
    * IsLastStepManager



  * Defined in libs/langgraph/dist/managed/is_last_step.d.ts:2
...
[constructor](langgraph.IsLastStepManager.html#constructor)

### Properties

[config](langgraph.IsLastStepManager.html#config) [lg_is_managed_value](langgraph.IsLastStepManager.html#lg_is_managed_value) [runtime](langgraph.IsLastStepManager.html#runtime)

### Methods

[addPromise](langgraph.IsLastStepManager.html#addPromise) [call](langgraph.IsLastStepManager.html#call) [promises](langgraph.IsLastStepManager.html#promises) [initialize](langgraph.IsLastStepManager.html#initialize)

## Constructors

### constructor[](#constructor)

  * new IsLastStepManager(config, _params?): [IsLastStepManager](langgraph.IsLastStepManager.html)[](#constructor.new_IsLastStepManager)
  * #### Parameters

    * config: RunnableConfig<Record<string, any>>
    * `Optional` _params: [ManagedValueParams](../interfaces/langgraph.ManagedValueParams.html)

#### Returns [IsLastStepManager](langgraph.IsLastStepManager.html)
...
Overrides [ManagedValue](langgraph.ManagedValue.html).[call](langgraph.ManagedValue.html#call)

    * Defined in libs/langgraph/dist/managed/is_last_step.d.ts:3
...
### `Static` initialize[](#initialize)
  ...
  * initialize<[Value](langgraph.IsLastStepManager.html#initialize.initialize-1.Value)>(_config, _args?): Promise<[ManagedValue](langgraph.ManagedValue.html)<[Value](langgraph.ManagedValue.html#initialize.initialize-1.Value-2)>>[](#initialize.initialize-1)
  * #### Type Parameters
...
[constructor](#constructor)[config](#config)[lg_is_managed_value](#lg_is_managed_value)[runtime](#runtime)[addPromise](#addPromise)[call](#call)[promises](#promises)[initialize](#initialize)
