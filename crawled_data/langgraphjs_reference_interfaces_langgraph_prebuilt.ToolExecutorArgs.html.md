---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/langgraph_prebuilt.ToolExecutorArgs.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [ToolExecutorArgs](langgraph_prebuilt.ToolExecutorArgs.html)
...
Use [ToolNode](../classes/langgraph_prebuilt.ToolNode.html) instead.

interface ToolExecutorArgs { [invalidToolMsgTemplate](langgraph_prebuilt.ToolExecutorArgs.html#invalidToolMsgTemplate)?: string; [tools](langgraph_prebuilt.ToolExecutorArgs.html#tools): (RunnableToolLike<ZodType<any, ZodTypeDef, any>, unknown> | StructuredToolInterface<ZodObjectAny>)[]; }

  * Defined in libs/langgraph/dist/prebuilt/tool_executor.d.ts:4
...
[invalidToolMsgTemplate?](langgraph_prebuilt.ToolExecutorArgs.html#invalidToolMsgTemplate) [tools](langgraph_prebuilt.ToolExecutorArgs.html#tools)

## Properties

### `Optional` invalidToolMsgTemplate[](#invalidToolMsgTemplate)
...
```
  ...
  * Defined in libs/langgraph/dist/prebuilt/tool_executor.d.ts:9
...
tools: (RunnableToolLike<ZodType<any, ZodTypeDef, any>, unknown> | StructuredToolInterface<ZodObjectAny>)[]
  ...
  * Defined in libs/langgraph/dist/prebuilt/tool_executor.d.ts:5
...
[invalidToolMsgTemplate](#invalidToolMsgTemplate)[tools](#tools)
