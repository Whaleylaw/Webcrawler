---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.BinaryOperatorAggregate.html
title: Untitled
date_crawled: 
---
...
#### Type Parameters
  ...
  * ValueType
  * UpdateType = [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1)



#### Hierarchy ([view full](../hierarchy.html#langgraph.BinaryOperatorAggregate))

  * [BaseChannel](langgraph.BaseChannel.html)<[ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1), [UpdateType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.UpdateType-1), [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1)>
    * BinaryOperatorAggregate



  * Defined in libs/langgraph/dist/channels/binop.d.ts:6
...
[constructor](langgraph.BinaryOperatorAggregate.html#constructor)

### Properties

[UpdateType](langgraph.BinaryOperatorAggregate.html#UpdateType-2) [ValueType](langgraph.BinaryOperatorAggregate.html#ValueType-2) [initialValueFactory?](langgraph.BinaryOperatorAggregate.html#initialValueFactory) [lc_graph_name](langgraph.BinaryOperatorAggregate.html#lc_graph_name) [operator](langgraph.BinaryOperatorAggregate.html#operator) [value](langgraph.BinaryOperatorAggregate.html#value)

### Methods

[checkpoint](langgraph.BinaryOperatorAggregate.html#checkpoint) [consume](langgraph.BinaryOperatorAggregate.html#consume) [fromCheckpoint](langgraph.BinaryOperatorAggregate.html#fromCheckpoint) [get](langgraph.BinaryOperatorAggregate.html#get) [update](langgraph.BinaryOperatorAggregate.html#update)

## Constructors

### constructor[](#constructor)

  * new BinaryOperatorAggregate<[ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1), [UpdateType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.UpdateType-1)>(operator, initialValueFactory?): [BinaryOperatorAggregate](langgraph.BinaryOperatorAggregate.html)<[ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1), [UpdateType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.UpdateType-1)>[](#constructor.new_BinaryOperatorAggregate)
  * #### Type Parameters
...
#### Parameters
    ...
    * operator: [BinaryOperator](../types/langgraph.BinaryOperator.html)<[ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1), [UpdateType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.UpdateType-1)>
    * `Optional` initialValueFactory: (() => [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1))
      *         * (): [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1)
        * #### Returns [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1)

#### Returns [BinaryOperatorAggregate](langgraph.BinaryOperatorAggregate.html)<[ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1), [UpdateType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.UpdateType-1)>

Overrides [BaseChannel](langgraph.BaseChannel.html).[constructor](langgraph.BaseChannel.html#constructor)

    * Defined in libs/langgraph/dist/channels/binop.d.ts:11
...
UpdateType: [UpdateType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.UpdateType-1)

Inherited from [BaseChannel](langgraph.BaseChannel.html).[UpdateType](langgraph.BaseChannel.html#UpdateType-2)
...
ValueType: [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1)

Inherited from [BaseChannel](langgraph.BaseChannel.html).[ValueType](langgraph.BaseChannel.html#ValueType-2)
...
### `Optional` initialValueFactory[](#initialValueFactory)

initialValueFactory?: (() => [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1))
...
#### Type declaration
  ...
  * Defined in libs/langgraph/dist/channels/binop.d.ts:10
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[lc_graph_name](langgraph.BaseChannel.html#lc_graph_name)

  * Defined in libs/langgraph/dist/channels/binop.d.ts:7
...
operator: [BinaryOperator](../types/langgraph.BinaryOperator.html)<[ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1), [UpdateType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.UpdateType-1)>
  ...
  * Defined in libs/langgraph/dist/channels/binop.d.ts:9



### value[](#value)

value: undefined | [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1)

  * Defined in libs/langgraph/dist/channels/binop.d.ts:8
...
### checkpoint[](#checkpoint)
  ...
  * checkpoint(): [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1)[](#checkpoint.checkpoint-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[checkpoint](langgraph.BaseChannel.html#checkpoint)

    * Defined in libs/langgraph/dist/channels/binop.d.ts:15
...
Inherited from [BaseChannel](langgraph.BaseChannel.html).[consume](langgraph.BaseChannel.html#consume)
...
#### Parameters
    ...
    * `Optional` checkpoint: [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1)

#### Returns this

Overrides [BaseChannel](langgraph.BaseChannel.html).[fromCheckpoint](langgraph.BaseChannel.html#fromCheckpoint)

    * Defined in libs/langgraph/dist/channels/binop.d.ts:12



### get[](#get)

  * get(): [ValueType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.ValueType-1)[](#get.get-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[get](langgraph.BaseChannel.html#get)

    * Defined in libs/langgraph/dist/channels/binop.d.ts:14
...
#### Parameters
    ...
    * values: [UpdateType](langgraph.BinaryOperatorAggregate.html#constructor.new_BinaryOperatorAggregate.UpdateType-1)[]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[update](langgraph.BaseChannel.html#update)

    * Defined in libs/langgraph/dist/channels/binop.d.ts:13
...
[constructor](#constructor)[UpdateType](#UpdateType-2)[ValueType](#ValueType-2)[initialValueFactory](#initialValueFactory)[lc_graph_name](#lc_graph_name)[operator](#operator)[value](#value)[checkpoint](#checkpoint)[consume](#consume)[fromCheckpoint](#fromCheckpoint)[get](#get)[update](#update)
