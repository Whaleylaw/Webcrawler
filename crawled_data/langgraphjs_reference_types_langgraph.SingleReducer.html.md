---
url: https://langchain-ai.github.io/langgraphjs/reference/types/langgraph.SingleReducer.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [SingleReducer](langgraph.SingleReducer.html)



# Type alias SingleReducer<ValueType, UpdateType>

SingleReducer<[ValueType](langgraph.SingleReducer.html#ValueType), [UpdateType](langgraph.SingleReducer.html#UpdateType)>: { default?: (() => [ValueType](langgraph.SingleReducer.html#ValueType)); reducer: [BinaryOperator](langgraph.BinaryOperator.html)<[ValueType](langgraph.SingleReducer.html#ValueType), [UpdateType](langgraph.SingleReducer.html#UpdateType)>; } | { default?: (() => [ValueType](langgraph.SingleReducer.html#ValueType)); value: [BinaryOperator](langgraph.BinaryOperator.html)<[ValueType](langgraph.SingleReducer.html#ValueType), [UpdateType](langgraph.SingleReducer.html#UpdateType)>; } | null

#### Type Parameters

  * ValueType
  * UpdateType = [ValueType](langgraph.SingleReducer.html#ValueType)



#### Type declaration

  * ##### `Optional` default?: (() => [ValueType](langgraph.SingleReducer.html#ValueType))

    *       * (): [ValueType](langgraph.SingleReducer.html#ValueType)
      * #### Returns [ValueType](langgraph.SingleReducer.html#ValueType)

  * ##### reducer: [BinaryOperator](langgraph.BinaryOperator.html)<[ValueType](langgraph.SingleReducer.html#ValueType), [UpdateType](langgraph.SingleReducer.html#UpdateType)>
...
#### Type declaration
  ...
  * ##### value: [BinaryOperator](langgraph.BinaryOperator.html)<[ValueType](langgraph.SingleReducer.html#ValueType), [UpdateType](langgraph.SingleReducer.html#UpdateType)>
...
Use `reducer` instead
  ...
  * Defined in libs/langgraph/dist/graph/annotation.d.ts:6
