---
url: https://langchain-ai.github.io/langgraphjs/reference/functions/langgraph.messagesStateReducer.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [messagesStateReducer](langgraph.messagesStateReducer.html)



# Function messagesStateReducer

  * messagesStateReducer(left, right): BaseMessage[][](#messagesStateReducer)
  * Prebuilt reducer that combines returned messages. Can handle standard messages and special modifiers like RemoveMessage instances.

#### Parameters

    * left: [Messages](../types/langgraph.Messages.html)
    * right: [Messages](../types/langgraph.Messages.html)

#### Returns BaseMessage[]

    * Defined in libs/langgraph/dist/graph/message.d.ts:9
