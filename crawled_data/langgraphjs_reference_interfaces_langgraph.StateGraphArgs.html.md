---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/langgraph.StateGraphArgs.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [StateGraphArgs](langgraph.StateGraphArgs.html)



# Interface StateGraphArgs<Channels>

interface StateGraphArgs<[Channels](langgraph.StateGraphArgs.html#Channels)> { [channels](langgraph.StateGraphArgs.html#channels-1): [Channels](langgraph.StateGraphArgs.html#Channels) extends object? [Channels](langgraph.StateGraphArgs.html#Channels)<[Channels](langgraph.StateGraphArgs.html#Channels)> extends unknown[]? ChannelReducers<{ __root__: [Channels](langgraph.StateGraphArgs.html#Channels)<[Channels](langgraph.StateGraphArgs.html#Channels)>; }>: ChannelReducers<[Channels](langgraph.StateGraphArgs.html#Channels)<[Channels](langgraph.StateGraphArgs.html#Channels)>>: ChannelReducers<{ __root__: [Channels](langgraph.StateGraphArgs.html#Channels); }>; }
...
#### Type Parameters
  ...
  * Defined in libs/langgraph/dist/graph/state.d.ts:13
...
[channels](langgraph.StateGraphArgs.html#channels-1)

## Properties

### channels[](#channels-1)

channels: [Channels](langgraph.StateGraphArgs.html#Channels) extends object? [Channels](langgraph.StateGraphArgs.html#Channels)<[Channels](langgraph.StateGraphArgs.html#Channels)> extends unknown[]? ChannelReducers<{ __root__: [Channels](langgraph.StateGraphArgs.html#Channels)<[Channels](langgraph.StateGraphArgs.html#Channels)>; }>: ChannelReducers<[Channels](langgraph.StateGraphArgs.html#Channels)<[Channels](langgraph.StateGraphArgs.html#Channels)>>: ChannelReducers<{ __root__: [Channels](langgraph.StateGraphArgs.html#Channels); }>

  * Defined in libs/langgraph/dist/graph/state.d.ts:14
