---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph_pregel.Channel.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [langgraph/pregel](../modules/langgraph_pregel.html)
  * [Channel](langgraph_pregel.Channel.html)



# Class Channel

  * Defined in libs/langgraph/dist/pregel/index.d.ts:14
...
[constructor](langgraph_pregel.Channel.html#constructor)

### Methods

[subscribeTo](langgraph_pregel.Channel.html#subscribeTo) [writeTo](langgraph_pregel.Channel.html#writeTo)

## Constructors

### constructor[](#constructor)

  * new Channel(): [Channel](langgraph_pregel.Channel.html)[](#constructor.new_Channel)
  * #### Returns [Channel](langgraph_pregel.Channel.html)
...
### `Static` subscribeTo[](#subscribeTo)

  * subscribeTo(channels, options?): [PregelNode](langgraph.PregelNode.html)<any, any>[](#subscribeTo.subscribeTo-1)
  * #### Parameters

    * channels: string
    * `Optional` options: { key?: string; tags?: string[]; }
      * ##### `Optional` key?: string

      * ##### `Optional` tags?: string[]

#### Returns [PregelNode](langgraph.PregelNode.html)<any, any>

    * Defined in libs/langgraph/dist/pregel/index.d.ts:15
  * subscribeTo(channels, options?): [PregelNode](langgraph.PregelNode.html)<any, any>[](#subscribeTo.subscribeTo-2)
  * #### Parameters

    * channels: string[]
    * `Optional` options: { tags?: string[]; }
      * ##### `Optional` tags?: string[]

#### Returns [PregelNode](langgraph.PregelNode.html)<any, any>

    * Defined in libs/langgraph/dist/pregel/index.d.ts:19



### `Static` writeTo[](#writeTo)

  * writeTo(channels, kwargs?): ChannelWrite<any>[](#writeTo.writeTo-1)
  * #### Parameters
...
#### Returns ChannelWrite<any>
    ...
    * Defined in libs/langgraph/dist/pregel/index.d.ts:22
...
[constructor](#constructor)[subscribeTo](#subscribeTo)[writeTo](#writeTo)
