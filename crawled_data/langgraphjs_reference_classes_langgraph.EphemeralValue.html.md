---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.EphemeralValue.html
title: Untitled
date_crawled: 
---
...
# Class EphemeralValue<Value>`Internal`
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.EphemeralValue))

  * [BaseChannel](langgraph.BaseChannel.html)<[Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1), [Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1), [Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)>
    * EphemeralValue



  * Defined in libs/langgraph/dist/channels/ephemeral_value.d.ts:6
...
[constructor](langgraph.EphemeralValue.html#constructor)

### Properties

[UpdateType](langgraph.EphemeralValue.html#UpdateType) [ValueType](langgraph.EphemeralValue.html#ValueType) [guard](langgraph.EphemeralValue.html#guard) [lc_graph_name](langgraph.EphemeralValue.html#lc_graph_name) [value](langgraph.EphemeralValue.html#value-2)

### Methods

[checkpoint](langgraph.EphemeralValue.html#checkpoint) [consume](langgraph.EphemeralValue.html#consume) [fromCheckpoint](langgraph.EphemeralValue.html#fromCheckpoint) [get](langgraph.EphemeralValue.html#get) [update](langgraph.EphemeralValue.html#update)

## Constructors

### constructor[](#constructor)

  * new EphemeralValue<[Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)>(guard?): [EphemeralValue](langgraph.EphemeralValue.html)<[Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)>[](#constructor.new_EphemeralValue)
  * #### Type Parameters
...
#### Returns [EphemeralValue](langgraph.EphemeralValue.html)<[Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)>

Overrides [BaseChannel](langgraph.BaseChannel.html).[constructor](langgraph.BaseChannel.html#constructor)

    * Defined in libs/langgraph/dist/channels/ephemeral_value.d.ts:10
...
UpdateType: [Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)
...
ValueType: [Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)
...
guard: boolean
  ...
  * Defined in libs/langgraph/dist/channels/ephemeral_value.d.ts:8
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[lc_graph_name](langgraph.BaseChannel.html#lc_graph_name)
  ...
  * Defined in libs/langgraph/dist/channels/ephemeral_value.d.ts:7



### value[](#value-2)

value: [] | [[Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)]

  * Defined in libs/langgraph/dist/channels/ephemeral_value.d.ts:9
...
### checkpoint[](#checkpoint)
  ...
  * checkpoint(): [Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)[](#checkpoint.checkpoint-1)
  * Return a string representation of the channel's current state.

#### Returns [Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[checkpoint](langgraph.BaseChannel.html#checkpoint)
    ...
    * Defined in libs/langgraph/dist/channels/ephemeral_value.d.ts:14
...
#### Parameters
    ...
    * `Optional` checkpoint: [Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)

#### Returns this

Overrides [BaseChannel](langgraph.BaseChannel.html).[fromCheckpoint](langgraph.BaseChannel.html#fromCheckpoint)

    * Defined in libs/langgraph/dist/channels/ephemeral_value.d.ts:11



### get[](#get)

  * get(): [Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)[](#get.get-1)
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[get](langgraph.BaseChannel.html#get)
    ...
    * Defined in libs/langgraph/dist/channels/ephemeral_value.d.ts:13
...
#### Parameters
    ...
    * values: [Value](langgraph.EphemeralValue.html#constructor.new_EphemeralValue.Value-1)[]
...
Overrides [BaseChannel](langgraph.BaseChannel.html).[update](langgraph.BaseChannel.html#update)
    ...
    * Defined in libs/langgraph/dist/channels/ephemeral_value.d.ts:12
...
[constructor](#constructor)[UpdateType](#UpdateType)[ValueType](#ValueType)[guard](#guard)[lc_graph_name](#lc_graph_name)[value](#value-2)[checkpoint](#checkpoint)[consume](#consume)[fromCheckpoint](#fromCheckpoint)[get](#get)[update](#update)
