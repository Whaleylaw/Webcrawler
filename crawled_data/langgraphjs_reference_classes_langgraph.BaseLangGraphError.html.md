---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.BaseLangGraphError.html
title: Untitled
date_crawled: 
---
...
#### Hierarchy ([view full](../hierarchy.html#langgraph.BaseLangGraphError))
  ...
  * Defined in libs/langgraph/dist/errors.d.ts:5
...
[constructor](langgraph.BaseLangGraphError.html#constructor)

### Properties

[lc_error_code?](langgraph.BaseLangGraphError.html#lc_error_code) [message](langgraph.BaseLangGraphError.html#message) [name](langgraph.BaseLangGraphError.html#name) [stack?](langgraph.BaseLangGraphError.html#stack) [prepareStackTrace?](langgraph.BaseLangGraphError.html#prepareStackTrace) [stackTraceLimit](langgraph.BaseLangGraphError.html#stackTraceLimit)

### Methods

[captureStackTrace](langgraph.BaseLangGraphError.html#captureStackTrace)

## Constructors

### constructor[](#constructor)

  * new BaseLangGraphError(message?, fields?): [BaseLangGraphError](langgraph.BaseLangGraphError.html)[](#constructor.new_BaseLangGraphError)
  * #### Parameters

    * `Optional` message: string
    * `Optional` fields: [BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html)

#### Returns [BaseLangGraphError](langgraph.BaseLangGraphError.html)
...
[constructor](#constructor)[lc_error_code](#lc_error_code)[message](#message)[name](#name)[stack](#stack)[prepareStackTrace](#prepareStackTrace)[stackTraceLimit](#stackTraceLimit)[captureStackTrace](#captureStackTrace)
