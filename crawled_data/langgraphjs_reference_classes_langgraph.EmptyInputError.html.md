---
url: https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.EmptyInputError.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [EmptyInputError](langgraph.EmptyInputError.html)



# Class EmptyInputError

#### Hierarchy ([view full](../hierarchy.html#langgraph.EmptyInputError))
  ...
  * Defined in libs/langgraph/dist/errors.d.ts:38
...
[constructor](langgraph.EmptyInputError.html#constructor)

### Properties

[lc_error_code?](langgraph.EmptyInputError.html#lc_error_code) [message](langgraph.EmptyInputError.html#message) [name](langgraph.EmptyInputError.html#name) [stack?](langgraph.EmptyInputError.html#stack) [prepareStackTrace?](langgraph.EmptyInputError.html#prepareStackTrace) [stackTraceLimit](langgraph.EmptyInputError.html#stackTraceLimit)

### Accessors

[unminifiable_name](langgraph.EmptyInputError.html#unminifiable_name)

### Methods

[captureStackTrace](langgraph.EmptyInputError.html#captureStackTrace)

## Constructors

### constructor[](#constructor)

  * new EmptyInputError(message?, fields?): [EmptyInputError](langgraph.EmptyInputError.html)[](#constructor.new_EmptyInputError)
  * #### Parameters

    * `Optional` message: string
    * `Optional` fields: [BaseLangGraphErrorFields](../types/langgraph.BaseLangGraphErrorFields.html)

#### Returns [EmptyInputError](langgraph.EmptyInputError.html)

Overrides [BaseLangGraphError](langgraph.BaseLangGraphError.html).[constructor](langgraph.BaseLangGraphError.html#constructor)

    * Defined in libs/langgraph/dist/errors.d.ts:39
...
### `Static` unminifiable_name[](#unminifiable_name)
  ...
  * #### Returns string
    ...
    * Defined in libs/langgraph/dist/errors.d.ts:40
