---
url: https://langchain-ai.github.io/langgraphjs/reference/interfaces/langgraph_prebuilt.HumanInterruptConfig.html
title: Untitled
date_crawled: 
---
...
[](#)
  ...
  * [HumanInterruptConfig](langgraph_prebuilt.HumanInterruptConfig.html)
...
interface HumanInterruptConfig { [allow_accept](langgraph_prebuilt.HumanInterruptConfig.html#allow_accept): boolean; [allow_edit](langgraph_prebuilt.HumanInterruptConfig.html#allow_edit): boolean; [allow_ignore](langgraph_prebuilt.HumanInterruptConfig.html#allow_ignore): boolean; [allow_respond](langgraph_prebuilt.HumanInterruptConfig.html#allow_respond): boolean; }

  * Defined in libs/langgraph/dist/prebuilt/interrupt.d.ts:10
...
[allow_accept](langgraph_prebuilt.HumanInterruptConfig.html#allow_accept) [allow_edit](langgraph_prebuilt.HumanInterruptConfig.html#allow_edit) [allow_ignore](langgraph_prebuilt.HumanInterruptConfig.html#allow_ignore) [allow_respond](langgraph_prebuilt.HumanInterruptConfig.html#allow_respond)
...
Whether the human can accept/approve the current state
  ...
  * Defined in libs/langgraph/dist/prebuilt/interrupt.d.ts:14
...
Whether the human can edit the provided content/state
  ...
  * Defined in libs/langgraph/dist/prebuilt/interrupt.d.ts:13
...
Whether the human can choose to ignore/skip the current step
  ...
  * Defined in libs/langgraph/dist/prebuilt/interrupt.d.ts:11
...
Whether the human can provide a text response/feedback
  ...
  * Defined in libs/langgraph/dist/prebuilt/interrupt.d.ts:12
...
[allow_accept](#allow_accept)[allow_edit](#allow_edit)[allow_ignore](#allow_ignore)[allow_respond](#allow_respond)
